...
type QuestionResult = boolean | null;
...
export default function PracticeSession() {
  ...
  const scorableResults = Object.values(results).filter(
    (result): result is boolean => result !== null,
  );
  const correctCount = scorableResults.filter(Boolean).length;
  const sessionScore =
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              >
                ...
                >
                  {scorableResults.length === 0 ? "N/A" : `${sessionScore}%`}
                </div>
            ...
            <div className="text-left mb-8 space-y-1.5">
              ...
              {questions.map((q, i) => {
                ...
                const unscored = answered && isCorrect === null;
                return (
                  <div
                    key={q.id}
