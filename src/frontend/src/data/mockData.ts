...
import { MOCK_1_SESSION_1_EXPLANATIONS } from "./mockExplanations";
import { MOCK_1_SESSION_1_QUESTION_OVERRIDES } from "./mockQuestionOverrides";
import {
  PRACTICE_PACK_QUESTIONS,
  PRACTICE_PACK_TOPICS,
} from "./practicePackData";
export const MOCK_TOPICS: Topic[] = [
  ...PRACTICE_PACK_TOPICS,
  {
    ...
    title: "Mock Exams",
    description:
      "Questions imported exactly from the uploaded CFA mock portal.",
    weight: "Full mock",
    questionCount: 1080,
    level: "I",
    order: 11,
...
const RAW_QUESTIONS = [
  [
    "Joy Nash, CFA, resides in Country 1, where applicable law is less strict than the Standards. Nash does business in Country 2, where applicable law is less strict than in Country 1. According to the Standards, when doing business in Country 2, Nash must follow:",
  ...
  [
    ...
    "Firms were including only top performing funds to represent their performance history.",
    "Asset managers were including the performance of all portfolios, including those no longer managed in their performance history.",
    "Consistency among fund managers were needed when making investment performance presentations.",
    "A",
  ],
  [
    "Daniel Morgan is a Level III candidate in the CFA Program. After taking the exam, Morgan signs into a CFA-candidate-only Internet forum and writes a post expressing the opinion that the CFA Program and examination policies are unfair. Has Morgan most likely violated the Standards?",
    "No.",
  ...
  [
    "Which of the following is permitted according to the Standards? A member:",
    "exploits market inefficiencies for personal trades.",
    "disseminates information to give the impression of increased liquidity of an asset.",
    "secures a dominant position in an underlying asset to control the price of its derivative.",
    "A",
  ],
  [
    'Ashley Brown, CFA, applies for a new job. She states, "As a CFA charterholder, I provide the best value in trade execution" and "I passed all three CFA Program examinations in three consecutive years." Has Brown violated the Standards?',
    "No.",
    "Yes, by stating she provides the best value in trade execution.",
    "Yes, by stating both the above statements.",
    "B",
  ],
  [
    "Yip Wai Yin, a CFA candidate, is an independent mutual fund sales agent receiving commissions for front-end and back-end load funds. She informs clients she is paid commission but does not provide details of the compensation structure. Which Standard does Yip least likely violate?",
    "Referral Fees.",
  ...
  [
    "Which of the following is a violation according to the Standard relating to preservation of confidentiality?",
    ...
    "When allowed under the law, members share confidential client information to defend themselves in a CFA Institute PCP investigation.",
    "A",
  ],
  [
    "Which of the following is a recommended procedure for compliance with the standard relating to responsibilities of supervisors? Once a violation from an employee is discovered, a supervisor should:",
    ...
    "Rely on an employee's written assurance that the wrongdoing will not reoccur.",
    "B",
  ],
  [
    "Dimitri Kuznetsov, CFA, holds shares of Barnikoff Limited and Matric Ventures in all client portfolios. Barnikoff proposes to change its financial year-end; Matric proposes to enter into a high-risk venture. Kuznetsov would least likely violate Standard III(A) if he votes:",
    "with management.",
    "only the Matric proxy.",
    "only the Barnikoff proxy.",
    "B",
  ],
  [
    "Umi Grabbo, CFA, and several employees begin development of their own hedge fund without informing her supervisor. According to the Standards of Practice Handbook, Grabbo should most likely address which Standard immediately?",
    "Priority of transactions.",
    "Avoid or disclose conflicts.",
  ...
  [
    "Which of the following member actions violates the Standard relating to misconduct? Action 1: Declaring personal bankruptcy. Action 2: Allocating for her personal account shares from an oversubscribed IPO suitable for her firm's clients.",
    "Action 1 only.",
    "Action 2 only.",
  ...
  [
    "Which of the following is NOT among the recommended procedures for compliance with the Standard relating to performance presentation?",
    "Excluding terminated accounts as part of the performance history.",
    "Presenting performance of the weighted composite of similar portfolios.",
    "Considering the sophistication of the audience to whom a performance presentation is addressed.",
    "A",
  ],
  [
    "Holly Baker, CFA is explaining CFA Institute Code of Ethics to a client. Which of the following statements could Baker make to most likely reflect disciplinary sanctions the CFA Institute may impose? Sanctions include:",
  ...
  [
    "Lawrence Hall, CFA, utilized his and Bishop's research to write a report but did not include Bishop's name because he changed Bishop's conclusion. Did Hall most likely violate any CFA Institute Standards?",
    "No.",
  ...
  [
    "According to the Standard relating to referral fees, members should disclose to employers the amount and nature of compensation received at least:",
    "monthly.",
    "quarterly.",
    "annually.",
    "B",
  ...
  [
    "In the absence of regulatory guidance, CFA Institute recommends that members maintain their investment research records for at least:",
    "3 years.",
    "5 years.",
    "7 years.",
    "C",
  ...
  [
    "Dennis Chung, CFA, tells clients: 'ATC is scheduled to announce a substantial stock repurchase program and its stock price will increase significantly.' Chung has violated the Standard(s) relating to:",
    "misrepresentation only.",
    "communication with clients and prospective clients only.",
    "misrepresentation as well as communication with clients and prospective clients.",
    "C",
  ],
  [
  ...
  [
    "Zhao Xuan, CFA, is convinced that Green Run's reported 50% increase in net income is fictitious. According to the CFA Institute Code of Ethics and Standards, the LEAST appropriate action for Zhao is to:",
  ...
  [
    ...
    "processes and procedures are designed to calculate and present performance results in compliance with the GIPS standards.",
    "A",
  ],
  [
    "Shruti Kurup, CFA, tells clients of her departure and cites lack of confidence in leadership as the reason, and says more employees are likely to leave soon. Kurup has violated the Standard(s) relating:",
    "only to loyalty.",
    "only to communication with clients and prospective clients.",
    "both to loyalty and to communication with clients and prospective clients.",
    "C",
  ],
  [
    "Anjuman Khan, CFA, accepts monetary compensation and two football tickets from clients, but discloses only the monetary compensation to her supervisor by text over the holiday weekend. Has Khan violated the Standard relating to independence and objectivity?",
    "No.",
    "Yes, because she failed to notify her supervisor of her acceptance of the tickets.",
    "Yes, because she failed to get prior approval for accepting the monetary compensation.",
    "B",
  ],
  [
    "According to the recommended procedures for compliance with the Standard relating to additional compensation arrangements, a member should make an immediate written report specifying any proposed compensation arrangements to:",
    "her supervisor only.",
  ...
  [
    "Brian Chan, CFA, CEO of Wholecare Pharmaceutical, posts on social media that WPC is launching a new medicine for heart disease, knowing it will positively impact WPC's stock price. Chan has violated the Standard(s) relating:",
    "only to misrepresentation.",
    "only to market manipulation.",
    "both to misrepresentation and to market manipulation.",
    "B",
  ],
  [
    "Which of the following risk premiums compensates investors for the risk of loss relative to an investment's fair value if the investment needs to be converted to cash quickly?",
    "Liquidity premium.",
    "Inflation premium.",
    "Maturity premium.",
    "A",
  ...
  [
    "Which of the following is most likely to signal manipulation of financial reporting for a large, diversified company?",
  ...
  [
    "Which of the following stakeholders in a mature company would most likely tolerate higher risks in return for higher return potential?",
    "Debtholders.",
    "Shareholders.",
  ...
  [
    "Which of the following is most likely a motivation for leasing long term rather than purchasing a high-value asset?",
  ...
  [
    "An analyst gathers the following information (in € millions) about a firm:\n\nTotal revenue: 100\nTotal variable costs: 75\nTotal fixed costs: 40",
    "All else being equal, the firm will most likely:",
    "operate in the long-run.",
    "exit the market in the short-run.",
    "operate in the short-run and exit the market in the long-run.",
    "C",
  ],
  [
    "Which of the following is most likely a drag on a company's liquidity position?",
  ...
  [
    "Which of the following companies would most likely have the highest level of information asymmetry between managers and shareholders? Companies:",
    "selling simple products.",
    "operating in multiple markets and geographies.",
    "with higher levels of institutional ownership and free float.",
    "B",
  ],
  [
    ...
    "At a 99% confidence level, the analyst should reject the null hypothesis that:",
    "the intercept is zero.",
    "the slope is less than or equal to 0.75.",
    "there is no linear relationship between the country's inflation rate and short-term interest rate.",
    "B",
  ],
  [
    "An analyst gathers the following data about an economy:\nReal trend growth rate: 0.5%\nCentral bank's policy rate: 1.5%",
    "If monetary policy is expansionary, the central bank's inflation target is:",
    "less than 1.0%.",
    "equal to 1.0%.",
    "greater than 1.0%.",
    "C",
  ...
  [
    "Which category of financial ratios is most likely used to measure how efficiently a company performs day-to-day tasks?",
    "Activity.",
    "Liquidity.",
    "Solvency.",
    "A",
  ...
  [
    "Deferred tax assets could arise when:",
    "an asset's tax base exceeds its carrying amount.",
    "an asset's carrying amount exceeds its tax base.",
    "taxes recognized on the income statement exceed income taxes payable.",
    "A",
  ],
  [
    "A positively skewed unimodal distribution of returns most likely has:",
  ...
  [
    "A sign of expansionary fiscal policy is a(n):",
  ...
  [
    "The redistribution of income and wealth is most directly associated with:",
    "fiscal policy only.",
  ...
  [
    "Under the revaluation model, an initial revaluation that increases the carrying value of an asset most likely results in a:",
  ...
  [
    ...
    "Basic earnings per share for the fiscal year is closest to:",
    "$0.91.",
    "$1.30.",
    "$1.73.",
    "B",
  ...
  [
    "If the average weekly hours worked in manufacturing decrease and unit labor costs remain the same, this most likely indicates future economic:",
    "decline.",
    "stability.",
    "growth.",
    "A",
  ...
  [
    "The role of lender of last resort in an economy is most likely fulfilled by the:",
    "government.",
    "central bank.",
    "banking system.",
    "B",
  ...
  [
    ...
    "The 180-day EUR/USD forward exchange rate is closest to:",
    "0.98662.",
    "0.98858.",
    "0.98956.",
    "A",
  ...
  [
    ...
    "Assuming it is highly probable that revenue will not be subsequently reversed, revenue (in millions) recognized in Year 1 is most likely:",
    "0.",
    "43.2.",
    "45.6.",
    "B",
  ...
  [
    "For a manufacturing company reporting under US GAAP, which of the following is classified as an operating activity on the statement of cash flows?",
    "Dividends paid.",
  ...
  [
    "Which of the following would best mitigate an analyst's confirmation bias when forecasting a firm's financial statements?",
  ...
  [
    "The third quintile corresponds to the:",
    "40th percentile.",
    "50th percentile.",
    "60th percentile.",
    "C",
  ...
  [
    "An inflation-targeting central bank most likely has a medium-term inflation target sufficiently:",
    "below zero to avoid the risk of deflation but high enough to ensure price stability.",
    "above zero to avoid the risk of deflation but low enough to ensure price stability.",
    "above zero to avoid the risk of inflation and high enough to ensure price stability.",
    "B",
  ],
  [
  ...
  [
    "A cooperative country is most likely to have characteristics of both:",
  ...
  [
    "A common market has a higher degree of economic integration than a(n):",
    "customs union.",
    "monetary union.",
    "economic union.",
    "A",
  ...
  [
    "With respect to intangible assets with indefinite lives reported under the cost model, which of the following must be disclosed?",
    "Date of revaluation.",
  ...
  [
    "A decrease in which of the following ratios decreases the cash conversion cycle?",
    "Payables turnover.",
    "Inventory turnover.",
  ...
  [
    "In periods of rising prices and increasing inventory quantities, using LIFO instead of FIFO most likely increases:",
    "total assets.",
    "cost of goods sold.",
  ...
  [
    "Costs incurred during the development phase that are related to internally generated, identifiable intangible assets:",
    "must be expensed.",
    "must be capitalized.",
  ...
  [
    "Which of the following is an assumption of Modigliani and Miller's propositions regarding capital structure?",
  ...
  [
    "In geopolitics, cabotage is best described as a:",
    "financial tool.",
    "multi-tool approach.",
  ...
  [
    ...
    "Upgrade of older production facilities to reduce costs.",
    "Modification of production processes to comply with new regulation.",
    "Funding research on the creation of new products based on an innovative technology.",
    "A",
  ],
  [
  ...
  [
    "A bank account has a stated annual interest rate of 3.5% with quarterly compounding. If the current value is $100,000, the future value two years from now is closest to:",
    "$107,123.",
    "$107,207.",
    "$107,218.",
    "C",
  ...
  [
    "The static trade-off theory of capital structure most likely considers:",
  ...
  [
    "A company is prohibited from reversing the impairment loss on a long-lived asset classified as:",
  ...
  [
    "If inventory that was written down in a previous reporting period subsequently increases in value, the amount of the original write-down can be reversed under:",
    "IFRS only.",
    "US GAAP only.",
  ...
  [
    "Goodness of fit measures derived from analysis of variance (ANOVA) data most likely include the:",
  ...
  [
    "If an auditor is experiencing some scope limitation, but can still issue an opinion, the auditor most likely issues a(n):",
    "qualified opinion.",
    "unqualified opinion.",
  ...
  [
    ...
    "The company's forecasted free cash flow to the firm is closest to:",
    "$43 million.",
    "$52 million.",
    "$55 million.",
    "B",
  ...
  [
    "With respect to business models, network effects can apply to:",
    "internet-based businesses only.",
    "non-internet-based businesses only.",
    "both internet-based businesses and non-internet-based businesses.",
    "C",
  ],
  [
  ...
  [
    "When calculating cash paid to suppliers based on income statement and balance sheet data, cost of sales is adjusted for changes in:",
    "inventory only.",
  ...
  [
    ...
    "The account balance at the end of the second year is closest to:",
    "€8,432.",
    "€9,672.",
    "€10,912.",
    "A",
  ...
  [
    "Electronics manufacturing company data (in € thousands):\n\nYear 2 / Year 1\nCost of sales: 1,250 / 1,000\nCost of inventory: 225 / 375\nNet realizable value of inventory: 300 / 325",
    "The inventory turnover (based on average inventory) for Year 2 is closest to:",
    "4.0.",
    "4.2.",
    "4.5.",
    "B",
  ...
  [
    "If the cost of capital exceeds the return on invested capital, shareholder value will:",
    "decrease.",
    "remain the same.",
    "increase.",
    "A",
  ...
  [
    "Risks associated with supplier relationships are typically mitigated through:",
    "contracts.",
    "regulation.",
  ...
  [
    "In the year of a change in accounting policy, comparability of the presented financial statements is best with:",
  ...
  [
    "Which of the following statements is most accurate? Cryptocurrencies:",
  ...
  [
    ...
    "in privately held companies only.",
    "in publicly traded companies only.",
    "both in privately held and in publicly traded companies.",
    "C",
  ],
  [
    "If a bond has a modified duration of 7.1 and convexity of 49.2, the percentage change in price for a 50 basis point increase in yield is closest to:",
    "-3.61%.",
    "-3.49%.",
    "-1.65%.",
    "B",
  ...
  [
    "The risk-free rate is 5%, and the market risk premium is 8%. If the beta of TRL Corp. is 1.5, based on CAPM, the expected return of TRL's stock is closest to:",
    "9.5%.",
    "15.5%.",
    "17.0%.",
    "C",
  ...
  [
    "Company's common stock and market information:\n\nDividend per share (D₀): $3.00\nDividend payout ratio: 25%\nEquity beta: 1.6\nExpected risk-free rate: 3.5%\nExpected market rate of return: 9.0%\nROE: 7.0%",
    "Using the Gordon growth model, the stock's intrinsic value is closest to:",
    "$24.96.",
    "$42.55.",
    "$44.79.",
    "C",
  ...
  [
    "A security's market value and intrinsic value are most likely the same if:",
    "the market is efficient.",
    "active investment is profitable.",
    "the security's cash flows are complex.",
    "A",
  ],
  [
    "All else being equal, which of the following indexes requires frequent rebalancing to adjust for price changes in the underlying securities?",
  ...
  [
    ...
    "If the required rate of return is 7% and the marginal tax rate is 30%, the preferred shares are most likely:",
    "undervalued.",
    "fairly valued.",
    "overvalued.",
    "A",
  ...
  [
    "Compared to a European waterfall, an American waterfall is:",
  ...
  [
    "Which of the following is most likely a factor that results in different credit ratings for debt issued by a subsidiary and debt issued by its parent company?",
  ...
  [
    "Which of the following types of investors most likely has a long-term investment time horizon and high liquidity needs?",
    "Endowments.",
  ...
  [
    "In a semi-strong-form efficient market, which of the following is reflected in prices?",
  ...
  [
    "With respect to securitization, time tranching is best described as the redistribution of:",
    "default risk.",
    "inflation risk.",
    "prepayment risk.",
    "C",
  ...
  [
    "The mental discomfort that occurs when new information conflicts with previously held beliefs is best described as:",
    "regret aversion.",
    "mental accounting.",
  ...
  [
    "In comparison to the makeup of fixed-income indexes, the constituent securities of equity indexes are best described as:",
    "more liquid.",
    "harder to price.",
  ...
  [
    "Which of the following is most accurate? A derivative:",
    "transforms risk of the underlying.",
    "derives its value from an underlying.",
    "derives its value based on the principle that arbitrage opportunities exist in the market.",
    "B",
  ],
  [
    "Investor information:\n\nRisk-free rate per annum: 1.50%\nExercise price: $9.75\n9-month call option price: $3.25",
    "According to put-call-forward parity, the price of a 9-month fiduciary call is closest to:",
    "$12.89.",
    "$13.00.",
    "$13.11.",
    "A",
  ...
  [
    ...
    "a smaller amount of required capital.",
    "C",
  ],
  [
  ...
  [
    "All else being equal, a bond issuer is most likely to be evaluated as less creditworthy than its peers if it has a:",
  ...
  [
    "Which of the following is most likely considered an investor constraint in an investment policy statement?",
    "Time horizon.",
    "Risk tolerance.",
    "Return requirement.",
    "A",
  ...
  [
    "A lifecycle fund will most likely:",
    "maintain a fixed asset allocation of stocks and bonds.",
    "use tactical asset allocation to capture market opportunities.",
    "change the asset allocation as the fund nears its target date.",
    "C",
  ],
  [
    "Measuring the duration of a bond portfolio as a weighted average of the individual bond durations:",
    "is difficult to use as a measure of interest rate risk.",
    "assumes the yield curve shifts in a parallel manner.",
    "assumes the yield curve shifts in a non-parallel manner.",
    "B",
  ],
  [
    "Analytical duration:",
    "assumes that government bond yields and spreads are independent variables.",
    "is lower than empirical duration for high-yield bonds under market stress scenarios.",
    "uses statistical methods and historical bond prices to derive the price-yield relationship for bond portfolios.",
    "A",
  ],
  [
    "Which of the following best describes the process of changing the distribution of risk outcomes by using derivatives?",
    "Risk shifting.",
    "Risk transfer.",
    "Risk avoidance.",
    "A",
  ...
  [
    "All else being equal, for option-free bonds, the percentage price change for a given yield change is most likely greater for a bond:",
    ...
    "when the market discount rate goes down than when the market discount rate goes up.",
    "C",
  ],
  [
  ...
  [
    "The capital asset pricing model (CAPM) is based on the assumption that investors are risk:",
    "averse.",
    "neutral.",
    "seeking.",
    "A",
  ...
  [
    "Based on put-call parity, an investor holding a long position in an underlying asset most likely creates a risk-free position by:",
    "only selling a call.",
  ...
  [
    "All else being equal, which of the following bonds most likely has the lowest price?",
    "Putable bond.",
    "Callable bond.",
    "Option-free bond.",
    "B",
  ...
  [
    ...
    "The correlation between the securities is closest to:",
    "-1.",
    "0.",
    "1.",
    "C",
  ...
  [
    "Industry classification systems are developed by:",
    "commercial entities only.",
    "governmental agencies only.",
    "both commercial entities and government agencies.",
    "C",
  ],
  [
    "Using the one-period binomial option pricing model, the value of an option will be affected by:",
    "the volatility of the underlying.",
    "a measure of investor risk aversion.",
    "the probabilities of up and down moves in the underlying.",
    "A",
  ],
  [
    "An analyst estimates the value of an option-free bond at 92.733 to yield 11%. The value is 94.474 for a 60 bps decrease in yield and 91.041 for a 60 bps increase in yield. The approximate modified duration of the bond is closest to:",
    "1.85.",
    "3.09.",
    "6.17.",
    "B",
  ...
  [
    "Securities dealers most likely:",
    "arrange IPOs.",
    "provide liquidity.",
    "securitize assets.",
    "B",
  ...
  [
    "Forward curve for one-year rates:\n\n0y1y: 1.20%\n1y1y: 1.88%\n2y1y: 2.46%\n3y1y: 2.93%",
  ...
  [
    "A company's cost of equity is a proxy for the:",
    "company's intrinsic value.",
    "company's accounting return on equity.",
    "minimum required rate of return of investors in the company's equity.",
    "C",
  ],
  [
    "At initiation, the price of a forward contract is most likely:",
  ...
  [
    "Which of the following statements about private debt is most accurate? Mezzanine debt is:",
  ...
  [
    "Enterprise value is most useful when:",
    "determining a measure of dividend-paying capacity.",
    "no market quotations for the company's debt are available.",
    "comparing companies with significant differences in capital structure.",
    "C",
  ],
  [
    "Which real estate sector is the largest globally by market value?",
    "Industrial.",
    "Residential.",
    "Commercial.",
    "B",
  ...
  [
    "Management fees for private equity funds are most likely based on:",
    "invested capital.",
    "committed capital.",
  ...
  [
    "A greenfield infrastructure investment is best described as an asset that has:",
  ...
  [
    "Which of the following drivers of timberland returns is not applicable to farmland?",
    "Land prices.",
    "Commodity prices.",
  ...
  [
    "An investor buys a stock for $108 on margin by posting 40% of the initial stock price as equity. If the maintenance margin requirement is 20%, a margin call first occurs when the price falls below:",
    "$64.80.",
    "$81.00.",
    "$86.40.",
    "B",
  ...
  [
    "A European call option has an exercise price of $80 and an option premium of $12. The price of the underlying is $75. The intrinsic value of the option is:",
    "0.",
    "5.",
    "7.",
    "A",
  ...
  [
    "If an investor buys a 5-year, 8% annual-pay bond for 96.11, the bond's yield-to-maturity is closest to:",
    "7.33%.",
    "8.32%.",
    "9.00%.",
    "C",
  ...
  [
    "In an investment policy statement, which of the following investment constraints most likely outlines a client's preference for environmentally sustainable investments?",
    "Time horizon.",
  ...
  [
    "If the current share price is $60, a trader who wants to purchase the share at $58 or less will most likely place a:",
    "limit order.",
    "market order.",
    "stop-buy order.",
    "A",
  ...
  [
    "Sponsored depository receipts are most likely subject to:",
    "less reporting requirements than unsponsored ones.",
    "the same level of reporting requirements as unsponsored ones.",
    "greater reporting requirements than unsponsored ones.",
    "C",
  ],
  [
    "Which of the following is best classified as a nonsystematic risk?",
  ...
  [
    "Four years ago, a 5% coupon, annual-pay bond with a 10-year maturity was issued at par. If the current market discount rate is 7%, the price of the bond per 100 of par value is closest to:",
    "90.34.",
    "90.47.",
    "93.23.",
    "B",
  ...
  [
    "The price of a fixed-rate corporate bond with an annual modified duration of 7.15 increases from 92 to 97 per 100 of par value. If the government benchmark yield increases by 5 bps, the estimated decline in the spread over the benchmark yield is closest to:",
    "71 bps.",
    "76 bps.",
    "81 bps.",
    "C",
  ...
  [
    "Commercial paper with a face value of $25,000,000 and a term of 120 days was issued 55 days ago. If the current market value is $24,855,000, the implied discount rate assuming a 360-day year is closest to:",
    "3.21%.",
    "3.23%.",
    "3.80%.",
    "A",
  ...
  [
    "The capital allocation line is best described as combinations of a risky portfolio and the:",
    "risk-free asset.",
    "market portfolio.",
  ...
  [
    "Which of the following most likely provides the greatest redemption flexibility?",
    "Hedge funds.",
  ...
  [
    "All else being equal, if a company declares a dividend of $1 per share, the company's share price is most likely to decrease by $1 on the:",
    "declaration date.",
    "ex-dividend date.",
  ...
  [
    "A call option with an exercise price of $38 was bought for $3. The price of the underlying increases from $42 to $47. At expiration, the payoff to the call buyer is equal to:",
    "$4.",
    "$6.",
    "$9.",
    "C",
  ...
  [
    "In the event of a default, which of the following mortgage structures exposes a lender to the greatest risk of loss?",
  ...
  [
    "Contracts entered into at one point in time that require both parties to engage in a transaction at a later point in time on terms agreed upon at the start are called:",
    "options contracts.",
    "contingent claims.",
    "forward commitments.",
    "C",
  ...
  [
    "A holder of a put option is best described as having a:",
    "short exposure to the option contract.",
    "long exposure to the underlying instrument.",
    "short exposure to the underlying instrument.",
    "C",
  ],
  [
    "A risk-neutral investor most likely seeks to maximize:",
  ...
  [
    "Pricing power is most likely lowest in markets characterized by:",
    "strong customer loyalty.",
    "high barriers to firm entry.",
    "low switching costs for customers.",
    "C",
  ],
  [
    "The value of a European call option is inversely related:",
    "only to the risk-free interest rate.",
    "only to the dividends paid by the underlying stock.",
    "both to the risk-free interest rate and to the dividends paid by the underlying stock.",
    "B",
  ],
  [
    "In which of the following stages of the enterprise risk management process will a company's board most likely identify shortfalls within the company that would cause it to fail to achieve critical goals? When:",
    "monitoring and mitigating risk.",
    "making the risk tolerance decision.",
    "allocating capital to risky activities.",
    "B",
  ],
  [
    "The underlying assets of an asset-backed security are directly owned by the:",
    "originator.",
  ...
  [
    "The earnings multiplier for a stock increases with a decrease in the:",
  ...
  [
    "With respect to portfolio construction, combining long-term capital market expectations with the objectives and constraints from the investment policy statement determines a portfolio's:",
    "security selection.",
  ...
  [
    "The central bank funds market is most likely used by:",
    "central banks looking to obtain short-term funding.",
    "lenders of last resort to transfer funds between each other.",
    "banks to manage the imbalances in their required reserves.",
    "C",
  ],
  [
  ...
  [
    "In an equally weighted portfolio of many assets, an increase in the correlation between the assets' returns most likely decreases the portfolio's:",
    "overall risk.",
    "expected return.",
  ...
  [
    "Which of the following is most likely considered an affirmative covenant?",
  ...
  [
    "An investor purchased shares on margin at €50 per share using a leverage ratio of 2.0. If the shares are sold for €70 per share, the return on the investor's equity investment is:",
    "40%.",
    "80%.",
    "180%.",
    "B",
  ...
  [
    "Trader's order book for a stock:\n\nAsk side (sell orders):\n42.76 → 6,800 shares\n42.68 → 9,100 shares\n42.64 → 6,600 shares\n42.60 → 2,400 shares\n\nBid side (buy orders):\n42.56 → 2,000 shares\n42.52 → 4,000 shares\n42.44 → 7,100 shares\n42.42 → 5,000 shares",
    "She receives an order to sell 9,000 shares with a limit price of CHF 42.52. The average price (in CHF) at which the trades will be executed is closest to:",
    "42.52.",
    "42.50.",
    "42.53.",
    "C",
  ...
  [
    "The two-fund separation theorem states that all investors will hold a combination of the:",
  ...
  [
    "With respect to an investment policy statement, a maximum acceptable level of tracking risk is best described as a(n):",
    "relative risk objective.",
    "absolute risk objective.",
    "systematic risk objective.",
    "A",
  ],
  [
  ...
  [
    ...
    "The firm claiming compliance",
    "Independent verification firms",
    "The performance measurement department",
    "A",
  ],
  [
    "To be consistent with the Standard relating to diligence and reasonable basis, members who develop quantitative models should:",
    "only understand the technical aspects of the products they provide to clients.",
    "only ensure the models incorporate a wide range of possible input expectations.",
    "both understand the technical aspects of the products they provide to clients and ensure the models incorporate a wide range of possible input expectations.",
    "C",
  ],
  [
    "A member who is an investment advisor receives a large unsolicited trade request from a client that is not aligned with the client's investment objectives. Which of the following actions by the member is consistent with the Standard relating to suitability? The member:",
    "immediately executes the trade.",
    "reduces the size of the requested investment and executes the trade.",
    "discusses the investment with the client, adjusts the client's investment policy statement, and executes the trade.",
    "C",
  ],
  [
    ...
    "Encourage staff retention with increased benefits.",
    "Create, implement, and monitor a corporate code of ethics",
    "B",
  ],
  [
    "Vishwanath Reddy, CFA, is the CEO of a brokerage firm that offers regular and premium services to clients. Clients can avail premium services paying a higher fee or by making referrals. Reddy does not disclose the referral fee arrangement because prospective clients who are referred to the firm are typically friends of existing clients. Reddy has violated the Standard(s) relating to:",
    "fair dealing only.",
    "referral fees only.",
    "both fair dealing and referral fees.",
    "B",
  ],
  [
    "The Standard relating to communication with clients and prospective clients requires members to inform which of the following of significant risks and limitations to the investment decision-making process?",
    "Clients only.",
  ...
  [
    "According to the Standard relating to responsibilities of supervisors, examining the firm's incentive structure to determine whether the structure encourages profits and returns at the expense of ethically appropriate conduct is the responsibility of:",
    "the firm only.",
    "the supervisor only.",
    "both the firm and the supervisor",
    "C",
  ],
  [
    "According to the Standard relating to additional compensation arrangements, a member must refuse to accept gifts which might reasonably be expected to create a conflict with her employer's interest unless the member obtains:",
    "verbal consent from her employer only.",
    "written consent from her employer only.",
    "written consent from all parties involved.",
    "C",
  ],
  [
    "The recommended procedures for compliance with the Standard relating to misconduct include which of the following?\nProcedure 1: Check references of potential employees to ensure that they are of good character.\nProcedure 2: Disseminate to all employees a list of potential violations by investment personnel and the associated disciplinary sanctions imposed by the firm.",
    "Only Procedure 1",
    "Only Procedure 2",
  ...
  [
    "Mila Roy, CFA, heads the research division of an investment firm. Roy sends a recommended stock list to all of her firm's clients along with a notification that a detailed report on each stock is available on request. Roy later calls only her premium fee-paying clients and discusses her recommendations. Such additional services are available for all clients willing to pay premium fees and is fully disclosed as part of the client agreement. Has Roy violated the Standards?",
    "No",
  ...
  [
    ...
    "Verification eliminates the need for in-depth due diligence of a GIPS-compliant firm for a prospective investor.",
    "Verification can be performed on a specific composite to ensure accuracy of the composite presentation.",
    "Verification provides assurance on whether the firm's policies and procedures related to pooled fund maintenance have been implemented on a firm-wide basis.",
    "C",
  ],
  [
    "John Pedersen, CFA, writes in his firm's promotional material:\nStatement 1: 'I passed all three CFA Program examinations in three consecutive years.'\nStatement 2: 'Being a CFA charterholder, I am among the elite of investment professionals.'\nHas Pedersen most likely violated the Standard(s)?",
    "No",
  ...
  [
    ...
    "The GIPS standards eliminate the need for in-depth due diligence by investors.",
    "Compliance with the GIPS standards enhances the credibility of investment management firms.",
    "Clients or prospective clients benefit from the GIPS standards because the historical track record of compliant firms is accurate and precise.",
    "B",
  ],
  [
    "A member presents investment performance to potential clients. According to the Standard relating to performance presentation, the member is permitted to omit which of the following in his presentation?",
    ...
    "Both simulated results as a source of performance data and supporting details of recommendations if the details are made available upon request.",
    "B",
  ],
  [
    "According to the Standard relating to loyalty, prudence, and care, members are most likely required to:",
  ...
  [
    ...
    "GIPS Composite Report to a prospective client.",
    "segregated account return to the account owner.",
    "GIPS Pooled Fund Report to a prospective investor.",
    "C",
  ],
  [
  ...
  [
    "Which of the following statements about bootstrap resampling is most accurate? The bootstrap resampling process requires:",
    "drawing random samples with replacement.",
    "an analytic formula to perform statistical inference.",
    "the number of repetitions to be equal to the sample size.",
    "A",
  ],
  [
    "The structural deficit is equal to the budget deficit:",
    "adjusted for inflation.",
    "that would exist at full employment.",
    "excluding the impact of automatic stabilizers.",
    "B",
  ],
  [
    "For a company with taxable income, if interest expense becomes tax deductible, the effective marginal cost of debt:",
    "decreases.",
    "remains the same.",
    "increases.",
    "A",
  ...
  [
    "In a perfectly competitive market, a firm's breakeven point is the minimum point of the:",
  ...
  [
    "Deductible temporary differences could arise when the:",
  ...
  [
    "Ignoring income taxes, an impairment loss on equipment will most likely decrease:",
    "net profit margin.",
  ...
  [
    "For a non-colluding oligopoly in a price war market, competitors are most likely to:",
    ...
    "match both a rival's price reduction as well as a rival's price increase.",
    "A",
  ],
  [
  ...
  [
    "Which of the following attributes is most accurate for a typical company in its start-up stage?",
  ...
  [
    "Which of the following statements about the use of financial ratios is most accurate?",
  ...
  [
    "One of the key roles played by central banks is:",
    "regulating the payments system.",
    "controlling aggregate demand with changes in tax rates.",
    "allocating resources between different sectors of the economy.",
    "A",
  ],
  [
  ...
  [
    "A primary aim of fiscal policy is to manage the economy through its influence on:",
    "real GDP.",
    "price stability.",
    "interest rates.",
    "A",
  ...
  [
    "An audit disclaimer of opinion is most likely issued when:",
    "management commentary is unaudited.",
    "auditors are unable to express an opinion.",
    "auditors determine that the financial statements materially depart from accounting standards and are not fairly presented.",
    "B",
  ],
  [
    "An analyst gathers the following information (in € millions) about a company's machine:\n\nCarrying amount prior to impairment: 8.0\nPresent value of expected future cash flows: 7.4\nUndiscounted expected future cash flows: 7.8\nCosts to sell: 0.2\nImpairment loss: 0.5",
  ...
  [
    "Target capital structure is often expressed using book values of equity and debt because:",
  ...
  [
    "According to capital allocation principles, managers should ignore:",
    "taxes.",
  ...
  [
    "The principal tool used to align the interests of management and shareholders is:",
    "regulation.",
    "proxy voting.",
    "compensation.",
    "C",
  ...
  [
    "With respect to fintech, which of the following statements is most accurate?",
  ...
  [
    "In hypothesis testing, the critical value is determined by the:",
    "p-value.",
    "sample's mean.",
  ...
  [
    "Which of the following market structures most likely has the greatest elasticity of demand?",
    "Oligopoly",
    "Perfect competition",
  ...
  [
    "An increase in utility for a company's products as these products become more widely adopted best describes:",
    "network effects.",
    "operating leverage.",
  ...
  [
    "Which of the following monetary policy regimes most likely imports the inflation of a foreign economy?",
    "Inflation targeting",
  ...
  [
    "Double taxation of income occurs when a corporation pays taxes on its profits, and additional taxes are paid by the:",
  ...
  [
    "With respect to the monetary transmission mechanism, a central bank's policy rate is initially transmitted through the economy via:",
    "inflation.",
    "asset prices.",
  ...
  [
    "Globalization is primarily the result of:",
  ...
  [
    "An analyst calculates a portfolio's target semideviation of returns over twelve consecutive months, including seven months of below-target returns. The sum of the squared deviations below the target is 42%. The target semideviation is closest to:",
    "1.87%.",
    "1.95%.",
    "2.65%.",
    "B",
  ...
  [
    "If all observations in a dataset have distinct positive values, which of the following relationships holds?",
  ...
  [
    "An analyst gathers the following information about a simple linear regression:\n\nIntercept: 1.0\nSlope coefficient: 1.5\nStandard error of the regression: 0.5",
    "If the value of the independent variable is 2.0, the value of the dependent variable predicted by the regression is closest to:",
    "3.5.",
    "4.0.",
    "4.5.",
    "B",
  ...
  [
    "An exchange rate regime based on an explicit legislative commitment to exchange domestic currency for a specified foreign currency at a fixed exchange rate is best described as a:",
    "monetary union.",
    "fixed parity system.",
  ...
  [
    ...
    "If the income tax rate is 30%, FCFF is:",
    "less than FCFE.",
    "the same as FCFE.",
    "greater than FCFE.",
    "C",
  ...
  [
    "The 'box' in a box and whisker plot represents the:",
    "interquartile range.",
  ...
  [
    "A company makes all sales on credit. According to the converged accounting standards for revenue recognition, a contract asset is most likely recognized on the seller's balance sheet when:",
    ...
    "revenue is recognized related to some of the contractual performance obligations that have been met.",
    "C",
  ],
  [
    "An investor purchases a security for $500,000. If the value of the security declines by 10% over the first 3-month period and then increases by 9% over the next 3-month period, the holding period return over the 6-month period is closest to:",
    "-1.9%.",
    "-1.0%.",
    "-0.5%.",
    "B",
  ...
  [
    "Proxy voting is best defined as a means for:",
  ...
  [
    "A bank has a stated annual interest rate of 7%. If an investor deposits 10,000 and earns $712.25 in interest over the first year, what frequency of compounding does the bank apply?",
    "Quarterly",
    "Continuous",
    "Semiannual",
    "C",
  ...
  [
    "An analyst estimates the following data about a company for the next year:\n\nInflation rate on the cost of sales: 10%\nIncrease in average selling price per unit: 7%\nDecrease in volumes sold: 3%",
    "If the company's cost of sales is 60% for the current year, the company's projected gross profit margin for next year is closest to:",
    "36.4%.",
    "38.3%.",
    "39.8%.",
    "B",
  ...
  [
    "A company that reports under US GAAP leases assets for its own use and classifies its leases as finance leases. In the first year of a lease, how would it most likely report a lease payment on its Statement of Cash Flows?",
    "The full payment in cash from operations",
    "The full payment in cash from financing activities",
    "The interest portion of the payment in cash from operations",
    "C",
  ],
  [
    "An analyst gathers the following information from a simple linear regression model with 30 observation pairs:\n\nSum of squares regression (SSR): 50\nSum of squares error (SSE): 16",
  ...
  [
    "Use of the asset-based valuation approach is most appropriate for a company with a high proportion of value attributed to:",
    "natural resources.",
    "business reputation.",
  ...
  [
    "An analyst gathers the following information (in $ millions) about two companies for the year just ended:\n\nCompany X: Operating income=10, Depreciation and amortization=2, Interest expense=1, Debt=50\nCompany Y: Operating income=12, Depreciation and amortization=1, Interest expense=3, Debt=60",
    "Based on an assessment of leverage, Company X has:",
    "lower creditworthiness than Company Y.",
    "the same creditworthiness as Company Y.",
    "higher creditworthiness than Company Y.",
    "C",
  ],
  [
    "With respect to the capital market line, the market portfolio is best described as the:",
    "optimal risky portfolio.",
    "portfolio that maximizes an investor's utility.",
    "optimal combination of the risk-free asset and a portfolio of risky assets.",
    "A",
  ],
  [
  ...
  [
    "Valuing private equity investments using estimated prices rather than market prices most likely causes an:",
  ...
  [
    "For an institutional investor, the investment committee's approach to appointing and reviewing investment managers for the portfolio is most likely set out during the:",
  ...
  [
    "Financial forecasting using historical base rates and convergence is best suited for companies that are:",
  ...
  [
    ...
    "market value is higher than intrinsic value.",
    "market value is lower than fundamental value.",
    "B",
  ],
  [
  ...
  [
    "The effective convexity of a bond is a measurement of the effect of a change in:",
    "horizon yield.",
  ...
  [
    "A 5% corporate bond makes annual coupon payments on 19 March of each year. If the bond is priced for settlement on 25 March at a yield-to-maturity of 5%, its flat price is:",
    "below par.",
    "par.",
    "above par.",
    "A",
  ...
  [
    ...
    "allows more opportunities to raise capital.",
    "allows management to better adopt a long-term focus.",
    "offers stronger incentives to improve corporate governance.",
    "B",
  ],
  [
    "Which of the following is used by clearinghouses to determine the gain and loss to the parties of a futures contract?",
  ...
  [
    "Which of the following asset-backed securities most likely utilizes credit tranching as a form of credit enhancement?",
    "Covered bond",
    "Credit card backed security",
  ...
  [
    "Compared with unregulated markets, regulated markets are best characterized by:",
    "higher transaction costs.",
  ...
  [
    "Which of the following is best categorized as a hard commodity?",
    "Cattle",
    "Lumber",
    "Crude oil",
    "C",
  ...
  [
    "Compared to the market value of a company's equity, the book value of a company's equity is most likely:",
    "measured by net income multiplied by ROE.",
    "influenced more directly by management decisions.",
    "reflective of investors' expectations about the company's future cash flows",
    "B",
  ],
  [
    "An analyst gathers the following information about a forward curve for one-year rates:\n\n0y1y: 0.60%\n1y1y: 1.05%\n2y1y: 2.90%\n3y1y: 2.69%",
  ...
  [
    "If the expected return of a stock is 15%, the expected market return is 10%, and the risk-free rate is 2%, the beta of the stock is closest to:",
    "1.30.",
    "1.50.",
    "1.63.",
    "C",
  ...
  [
    "Which of the following involves a private equity firm introducing leverage to its portfolio company and paying itself a dividend out of the new capital structure?",
    "Venture debt",
    "Recapitalization",
    "Mezzanine loans",
    "B",
  ...
  [
    "An investor gathers the following information about a European call option with 9 months until expiration:\n\nCurrent stock price: $112\nStrike price of option: $115\nCurrent call option price: $4\n1-year risk free rate: 2.5%",
    "According to put-call parity, the current price of a put option with the same maturity and strike price is closest to:",
    "3.11",
    "4.2",
    "4.89",
    "C",
  ...
  [
    "A bond has an annual modified duration of 5.359, an annual convexity of 248.23, and is currently yielding 3.5%. If the bond's yield-to-maturity increases to 3.7%, the expected percentage price change is closest to:",
    "-1.02%.",
    "-0.97%",
    "1.12%.",
    "B",
  ...
  [
    "Direct ownership of commercial real estate most likely:",
  ...
  [
    "The returns of Asset 1 and Asset 2 are perfectly positively correlated. If the assets have the same standard deviation of returns, the covariance between the returns of the assets is equal to the:",
  ...
  [
    "During times of severe market turmoil, the risk reduction from portfolio diversification most likely:",
    "decreases.",
    "remains the same.",
    "increases.",
    "A",
  ...
  [
    "Which of the following statements regarding forward contracts is most accurate?",
    "The value of a short forward contract is the spot price minus the forward price at expiration",
    "The value of a long forward contract increases as the spot price of the underlying increases",
    "The forward price is the spot price compounded at the risk premium over the life of the contract",
    "B",
  ],
  [
    "An example of nonsystematic risk is a(n):",
  ...
  [
    "Which of the following alternative investment categories most likely provides exposure to capital-intensive, long-lived assets that provide essential public services?",
    "Infrastructure",
    "Venture capital",
  ...
  [
    "According to put-call-forward parity, a long put and a short call is equal to:",
    "a long bond and a short forward.",
    "a short bond and a long forward.",
    "a short bond and a short forward.",
    "A",
  ],
  [
    "Which of the following cognitive errors is best classified as a belief perseverance bias?",
    "Availability bias",
    "Confirmation bias",
  ...
  [
    "A limit order book (in € per share) has the following order prices:\n\nBids: 47.85 / 47.70\nAsks: 48.20 / 48.00",
  ...
  [
    "Which of the following most likely accounts for most of the long-term changes in a portfolio's value?",
    "Beta",
    "Alpha",
    "Security selection",
    "A",
  ...
  [
    ...
    "Which company has the lowest price-to-book value per share?",
    "Company 1",
    "Company 2",
    "Company 3",
    "B",
  ...
  [
    "In contrast to life insurers, property and casualty insurers most likely:",
  ...
  [
    ...
    "denominated in USD.",
    "sold to US investors at issuance.",
    "underwritten by a syndicate of US-based banks.",
    "A",
  ],
  [
    "Which of the following statements about market efficiency is most accurate? In a:",
    "weak-form efficient market, technical analysis generates abnormal returns over the long run.",
    "semi-strong-form efficient market, active portfolio managers outperform the market on a consistent basis.",
    "strong-form efficient market, insiders would not be able to earn abnormal returns from trading on private information",
    "C",
  ],
  [
    "The type of developed market bond that most likely has the greatest risk of default is a:",
    "revenue bond.",
    "sovereign bond.",
  ...
  [
    "An increase in which of the following most likely increases the time value of a European put option?",
  ...
  [
    "The behavioral bias that best describes investors reacting slowly to new information is:",
    "conservatism bias.",
    "narrow framing bias.",
  ...
  [
    "A bond's price sensitivity to a non-parallel shift in the benchmark yield curve is best measured by:",
    "key rate duration.",
    "effective duration.",
    "modified duration",
    "A",
  ...
  [
    "Which of the following financial intermediaries most likely buy and sell similar instruments at different prices in different markets?",
    "Dealers",
    "Brokers",
    "Arbitrageurs",
    "C",
  ...
  [
    "Prior to expiration, an at-the-money option most likely trades:",
  ...
  [
    "A $100,000,000 par value bond has a value of $88,500,000 and an annual modified duration of 7.75. If the yield-to-maturity decreases by 100 basis points, the change in value is closest to:",
    "-$6,858,750.",
    "$6,858,750.",
    "$7,750,000.",
    "B",
  ...
  [
    "If a portfolio consists of two risky assets and the portfolio's standard deviation is equal to the weighted average of the assets' standard deviations, the assets' returns are:",
  ...
  [
    ...
    "If the bond currently trades at a price of 96.63 with a yield-to-maturity of 5.0%, the approximate convexity is closest to:",
    "-4.851.",
    "-0.039.",
    "-0.019.",
    "C",
  ...
  [
    "Which of the following statements best describes the relationship between the net costs of carry and the forward price?",
  ...
  [
    "An analyst observes the fee structure and performance of a hedge fund with $100 million assets under management at the beginning of the year:\n\nAnnual management fee: 2%\nIncentive fee: 20%\nHard hurdle rate: 3%",
    "The annual management fee is based on the year-end valuation, and the incentive fee is calculated net of the management fee. If the fund return before fees is 10% at year end, the total annual fee earned by the fund manager is closest to:",
    "$3.2 million.",
    "$3.6 million.",
    "$3.8 million.",
    "A",
  ...
  [
    ...
    "sell securities they own.",
    "borrow securities from security lenders.",
    "cannot lose more than their initial investment.",
    "B",
  ],
  [
    "In the priority of claims, the class of corporate debt that has the lowest priority of payments in the event of default is most likely:",
    "second lien debt.",
    "subordinated debt.",
  ...
  [
    "Which of the following is an exclusive feature of private equity funds as opposed to hedge funds?",
    "Hurdle rates",
    "Performance fees",
  ...
  [
    "The CAPM states that two assets with the same expected return will have the same:",
    "standard deviation.",
  ...
  [
    ...
    "The general partner theoretically has limited liability.",
    "Co-investment rights allow the limited partner to make additional direct investments in portfolio companies.",
    "The side letter is a legal document that outlines the rules of the partnership between the general partners and all limited partners.",
    "B",
  ],
  [
    "A bond that allows the issuer to pay interest in the form of additional amounts of the existing bond issue rather than a cash payment best describes a:",
    "step-up coupon bond.",
  ...
  [
    "A mutual fund that does not have a sales charge to purchase or redeem shares in the fund is best described as a(n):",
  ...
  [
    "An investor buys a stock on margin, posting 60% of the initial $63.00 per share price as equity. All else being equal, if the investor receives a margin call at $33.60 per share, the maintenance margin on this trade is:",
    "12.5%.",
    "25.0%.",
    "40.0%.",
    "B",
  ...
  [
    "Redemption regimes are a feature of:",
    "covered bonds.",
  ...
  [
    "An investor collects the following information about a put option:\n\nStock price at initiation: $110\nStrike price: $105\nOption premium: $4.50",
    "At expiration, if the price of the stock is $100, the investor's profit from selling the put is:",
    "-$0.50.",
    "$4.50.",
    "$9.50.",
    "A",
  ...
  [
    "Which of the following features of an established hedge fund is most likely designed to allow orderly liquidation of positions to meet redemptions?",
    "Notice period",
    "Lockup period",
    "Redemption fee",
    "A",
  ...
  [
    "Which of the following statements is most accurate? US commercial paper typically:",
  ...
  [
    "If 1,000 shares of stock purchased at $30 per share on 75% margin are later sold at $26 per share, the return on equity is closest to:",
    "-17.8%.",
    "-13.3%.",
    "-10.0%.",
    "A",
  ...
  [
    "Which of the following risk metrics reflects the risk of changes in an option's delta?",
    "Rho",
    "Vega",
    "Gamma",
    "C",
  ...
  [
    "The Markowitz efficient frontier is best described as the part of the minimum-variance frontier of risky assets that plots:",
    "to the right of the risk-free asset.",
    "above the global minimum-variance portfolio.",
    "above and to the right of the optimal risky portfolio.",
    "B",
  ],
  [
    "In a declining interest rate environment, an investor would find it most difficult to estimate future cash flows for which of the following bonds with similar maturities?",
    "Putable bond",
  ...
  [
    "In the investment policy statement of a pension fund, a countrywide limit on the proportion of high-risk assets that can be held in long-term pension portfolios is most likely a:",
  ...
  [
    "An analyst calculates the duration of a portfolio containing only fixed-rate bonds, callable bonds, and asset-backed securities. Which duration measure is the most appropriate to use?",
    "Macaulay duration",
    "Effective duration",
    "Modified duration",
    "B",
  ...
  [
    "A key motivation for adding alternative investments to a portfolio is most likely the:",
    "potential for diversification.",
    "ease of selecting portfolio managers.",
  ...
  [
    ...
    "requires an estimate of future dividend payments.",
    "can be used to value non-dividend paying stocks.",
    "treats non-cash expense in the same manner as cash expense.",
    "B",
  ],
  [
    "Yield measures for both bonds and money market instruments are most likely:",
    "compounded.",
  ...
  [
    "According to the Standard relating to suitability, a member should update a client's Investment Policy Statement at least:",
    "quarterly.",
    "semiannually.",
    "annually.",
    "C",
  ...
  [
    "Ritu Jain, CFA, is preparing to leave her firm and join a new employer. Prior to leaving the firm, Jain calls all her clients informing them of her decision to leave. When asked by the clients, Jain states lack of confidence in the firm's leadership as the reason for her departure and also mentions that more employees are likely to leave soon. Jain has violated the Standard(s) relating:",
    "only to loyalty.",
    "only to preservation of confidentiality.",
    "both to loyalty and to preservation of confidentiality.",
    "A",
  ],
  [
    "Which of the following is not a requirement of Standard I, Integrity of Capital Markets? Members and candidates:",
    "must promote the integrity and viability of the global capital markets for the ultimate benefit of society.",
  ...
  [
    "Benefits of compliance with the GIPS standards least likely include:",
    "strengthening internal controls.",
    "participating in competitive bidding.",
    "eliminating in-depth due diligence for investors.",
    "C",
  ],
  [
  ...
  [
    "Maria Bendez, CFA, is a well-known analyst. She sends her recommendations to all of her firm clients. However, Bendez does not disseminate her recommendations to the public even though she believes that her recommendations could affect security prices. A client calls her and says: 'Maria, thank you! Every time you send me your recommendations, I think you provide me with an advantage over other market participants.' Has Bendez most likely violated the Standards?",
    "No",
    "Yes, the Standard relating to material nonpublic information",
    "Yes, the Standard relating to material nonpublic information and the Standard relating to fair dealing",
    "A",
  ],
  [
    "According to the Standard relating to preservation of confidentiality, a member is required to maintain confidentiality of information communicated to her:",
    "by her former clients only.",
    "by her prospective clients only.",
    "both by her former clients and by her prospective clients.",
    "C",
  ],
  [
    "A firm manages $500 million in large-cap equity portfolios. Of this, non-fee-paying portfolios amount to $50 million, and fee-paying non-discretionary portfolios total $75 million.",
    "To be compliant with the GIPS standards, the firm must present the value of its large-cap composite as:",
    "$375 million.",
    "$425 million.",
    "$450 million.",
    "A",
  ...
  [
    "Megan Chandra, CFA, allocates an oversubscribed IPO suitable for all the accounts she manages. Chandra does not allocate the IPO her mother's standard fee-paying account or her husband's non-fee-paying account. Has Chandra violated the Standards?",
    "No",
    "Yes, by not allocating the IPO allocation to her mother's account",
    "Yes, by not allocating the IPO allocation to both her husband's and her mother's accounts",
    "B",
  ],
  [
    "Which of the following is not a recommended procedure for compliance with the Standard relating to misrepresentation? Firms should:",
    "avoid verifying information from third-party firms for timely trade executions.",
    "specifically designate which employees are authorized to speak on behalf of the firm.",
    "periodically review employee correspondence that contains representations of individual qualifications.",
    "A",
  ],
  [
    "A portfolio manager is hired by an executive manager of a trust. The duty of loyalty is owed to the:",
    "trustee.",
    "executive manager.",
  ...
  [
    "According to the recommended procedures for compliance with the Standard relating to record retention, who is most likely responsible for maintaining the records that support investment actions?",
    "The firm",
    "Research analysts",
  ...
  [
    "Arshani Madan, CFA, develops a product that selects mutual funds based on historical data. Madan tests her methodology and produces simulated performance results. The promotional material for the product does not indicate that the results are simulated. Madan has violated the Standards relating:",
    "only to performance presentation.",
    "only to communication with clients and prospective clients.",
    "both to performance presentation and communication with clients and prospective clients.",
    "C",
  ],
  [
  ...
  [
    ...
    "only about the erroneous purchase of lY shares.",
    "only about outsourcing a portion of the clients' portfolios to an external manager.",
  ...
  [
    "According to the Standard relating to conduct as participants in CFA Institute programs, CFA candidates are permitted to:",
    "disclose broad topical areas not tested on the exam.",
    "discuss curriculum material in study groups in preparation for the exam.",
    "disclose information on formulas tested in the exam after taking the exam.",
    "B",
  ],
  [
    "The Standard relating to misconduct addresses:",
    "only all conduct that reflects poorly on members' professional integrity.",
    "only all actions violating trust in members' professional and private lives.",
    "both all conduct that reflects poorly on members' professional integrity and all actions violating trust in members' professional and private lives.",
    "C",
  ],
  [
  ...
  [
    "An analyst gathers the following information (in $ millions) about a company's current fiscal year:\n\nNet income: 20\nInterest expensed and paid: 2\nDepreciation expense: 4\nTaxes paid: 6",
  ...
  [
    "If trading partners are to benefit from allowing the free movement of factors of production among their members, the trading partners most likely need to form a:",
    "customs union.",
    "free trade area.",
    "common market.",
    "C",
  ...
  [
    "With respect to debt securities measured at fair value through other comprehensive income:",
    "both interest income and unrealized gains and losses are recognized in other comprehensive income.",
    "interest income is recognized in other comprehensive income while unrealized gains and losses are not recognized.",
    "interest income is recognized in profit and loss while unrealized gains and losses are recognized in other comprehensive income.",
    "C",
  ],
  [
    "For a non-colluding oligopoly with a price leader, the optimal market price is determined by the:",
    "dominant firm's demand schedule.",
    "market's aggregate demand curve.",
    "market's marginal revenue and marginal cost.",
    "B",
  ],
  [
  ...
  [
    "Which of the following statements is most accurate? Fintech applications:",
  ...
  [
    "When estimating a target capital structure, the equity weight associated with a debt-to-equity ratio of 0.6 is closest to:",
    "37.5%",
    "40.0%.",
    "62.5%.",
    "C",
  ...
  [
    "A company is forecasting 10% organic growth in revenues. The company believes sales volume will grow by 6.4%. The forecasted price/mix impact for the company is closest to:",
    "3.4%.",
    "17.0%.",
    "56.3%",
    "A",
  ...
  [
    "In hypothesis testing, which of the following is stated in terms of population parameters?",
  ...
  [
    "In ESG factor analysis, a company's ownership of stranded assets is most likely considered a(n):",
    "environmental risk.",
    "social risk.",
    "governance risk.",
    "A",
  ...
  [
    "Using market levels as signals to measure the likelihood of a geopolitical risk best describes:",
    "signposting.",
    "scenario analysis.",
    "geopolitical risk translation into investment action.",
    "A",
  ],
  [
  ...
  [
    "A firm reports sales of €50,000 for a year ended 31 December. Its accounts receivable balances were €6,000 on 1 January of the year and €7,500 on 31 December. The company's cash collections from sales for the year is closest to:",
    "€42,500.",
    "€48,500.",
    "€51,500",
    "B",
  ...
  [
    "If differences between accounting profit and taxable income are recoverable, deferred tax assets are created when:",
  ...
  [
    "A company receives a subscription payment for a publication to be delivered next fiscal year. Ignoring income taxes, the company would recognize in the current fiscal year an increase in:",
    "assets and revenue.",
  ...
  [
    "An analyst examines the following quarterly returns for a client's portfolio:\nQ1: 8%, Q2: 3%, Q3: -2%, Q4: 10%, Q5: 8%, Q6: 0%, Q7: -3%, Q8: 12%",
  ...
  [
    "Which of the following statements about prediction intervals is most accurate? All else being equal:",
    "the width of the prediction interval does not depend on the standard error of the estimate.",
    "a smaller variation of the independent variable will result in a narrower prediction interval.",
    "a larger sample size in the regression estimation will result in a smaller standard error of the forecast.",
    "C",
  ],
  [
  ...
  [
    "An analyst calculates the following metrics about a sample of paired observations of a dependent variable Y and an independent variable X:\n\nVariance of X: 9\nVariance of Y: 15\nCovariance of Y and X: 12",
  ...
  [
    "A company's ability to support debt most likely improves with a(n):",
  ...
  [
    "Which of the following is an assumption in Modigliani and Miller's capital structure framework?",
    "Investors can lend and borrow at the risk free rate",
    "Interest expense is deductible from income for tax purposes",
    "Investors have heterogeneous expectations about future corporate earnings",
    "A",
  ],
  [
    "Which of the following sampling methods involves selecting every kth member from a population until a desired sample size is obtained?",
    "Cluster sampling",
    "Systematic sampling",
  ...
  [
    "For a company paying preferred dividends, the components needed to compute basic EPS are net income:",
    ...
    "preferred dividends, additional shares issued if preferred is converted, and the weighted average number of common shares outstanding.",
    "B",
  ],
  [
    "A company's cash contribution to its defined contribution pension plan is recorded on the company's statement of cash flows as a(n):",
  ...
  [
    "Part of the conflict between shareholders and debtholders is that shareholders prefer:",
    "less business risk than debt holders.",
    "more equity issuance than debtholders.",
    "greater financial leverage than debt holders.",
    "C",
  ],
  [
    "An analyst gathers the following information about a company's capital sources:\n\nTarget weight of debt: 25%\nTarget weight of equity: 75%\nBefore-tax marginal cost of debt: 4%\nMarginal cost of equity: 12%",
  ...
  [
    "Which of the following is most likely a feature of sole proprietorships?",
    "Operational complexity",
    "Existence of a legal identity",
    "Taxation of business profits as personal income",
    "C",
  ],
  [
    "With respect to the cash flow statement, under US GAAP, interest paid is reported as a(n):",
    "investing activity.",
    "financing activity.",
    "operating activity.",
    "C",
  ...
  [
    "Tiered pricing is best described as:",
    "charging different prices at different times.",
    "charging different prices to different buyers.",
    "combining a low price on a piece of equipment with high-margin pricing on repeat-purchase consumables.",
    "B",
  ],
  [
    "The Herfindahl-Hirschman index (HHI) is more responsive than the concentration ratio to:",
  ...
  [
    "In jackknife resampling:",
    "the results are similar for every resample.",
    "the required number of repetitions is the same as in bootstrap resampling.",
    "each subsequent resample has one less observation than the previous resample.",
    "C",
  ],
  [
    "Under US GAAP, which of the following is least likely a disclosure concerning inventory?",
    "The amount of the reversal of any write-down of inventories",
  ...
  [
    "Firms operating under a monopolistic competition market structure most likely:",
  ...
  [
    "Which of the following is most likely a distinction between futures and forward contracts? Futures contracts are:",
    "easily customized.",
  ...
  [
    "Which of the following yield curves is a sequence of breakeven reinvestment rates?",
    "Par curve",
    "Spot curve",
    "Forward curve",
    "C",
  ...
  [
    "The sensitivity of a 30-year fixed-rate bond to a 50 basis points increase in the benchmark rate at the 25-30 years maturity segment is best measured by:",
    "key rate duration.",
    "effective duration.",
    "modified duration.",
    "A",
  ...
  [
    ...
    "coupon rate on a government bond with a similar time to maturity.",
    "yield to maturity on a government bond with a similar time to maturity.",
    "yield to maturity on a corporate bond with similar credit risk and time to maturity.",
    "B",
  ],
  [
    "Which type of preference shares can be exchanged into a predetermined number of common shares?",
  ...
  [
    "Privately held convertible debt is most likely used by companies in which of the following life cycle stages?",
    "Seed",
    "Growth",
    "Maturity",
    "B",
  ...
  [
    "Which of the following industries would most likely be included in the 'mature and cyclical' quadrant of an industry growth style box?",
    "Semiconductors",
    "Pharmaceuticals",
  ...
  [
    ...
    "If the covariance between the two assets is 0.04, the portfolio variance is closest to:",
    "0.04.",
    "0.06.",
    "0.12.",
    "B",
  ...
  [
    "Pooled investment vehicles that frequently trade at a significant discount to net asset value are most likely:",
    "closed-end funds.",
    "open-ended funds.",
  ...
  [
    ...
    "Based solely on the P/E and P/CF ratios, which company appears overvalued?",
    "Company A",
    "Company B",
    "Company C",
    "A",
  ...
  [
    ...
    "Markets have zero transaction costs.",
    "Investors plan for multiple holding periods.",
    "Large investors can influence security prices.",
    "A",
  ],
  [
    "Short sellers most likely:",
  ...
  [
    "With regard to their investment in pension plans, employees with defined contribution plans accept:",
    "inflation risk only.",
    "investment risk only.",
    "both inflation and investment risks.",
    "C",
  ],
  [
  ...
  [
    "An investor values a company based on the dividend discount model. All else being equal, the estimated intrinsic value of the stock for a one-year holding period is most likely:",
    "lower than the estimated intrinsic value of the stock for a five-year holding period.",
    "equal to the estimated intrinsic value of the stock for a five-year holding period.",
    "higher than the estimated intrinsic value of the stock for a five-year holding period.",
    "B",
  ],
  [
    "A credit issuer rating assigned by a rating agency is based on:",
    "the notching adjustment of a specific bond of the issuer.",
    "the ranking of a specific bond in the issuer's capital structure.",
    "the issuer's ability and willingness to service its senior unsecured debt.",
    "C",
  ],
  [
  ...
  [
    ...
    "A contract to sell Alphabet Inc.'s shares at a fixed price",
    "A contract to buy Australian dollars at a predetermined exchange rate",
    "A",
  ],
  [
    "Accounting standards and reporting requirements that produce meaningful and timely financial disclosures are most critical for achieving which of the following efficiencies associated with a well-functioning financial system?",
    "Allocational",
    "Informational",
    "Operational",
    "B",
  ...
  [
    "Which of the following is least likely a primary reason a company would raise capital through the issuance of equity securities?",
  ...
  [
    "Mass redemptions may force the sale of underlying real estate by managers of:",
    "open-end funds only.",
    "publicly traded REITs only.",
    "both open-end funds and publicly traded REITs.",
    "A",
  ],
  [
  ...
  [
    ...
    "A Japanese borrower issuing US dollar-denominated bonds in the US market.",
    "A Canadian borrower issuing British pound-denominated bonds in the UK market.",
    "An Australian borrower issuing Canadian dollar-denominated bonds in the UK market.",
    "C",
  ],
  [
    "For a bond investment, loss severity is:",
  ...
  [
    "For European options, all else being equal, a higher exercise price results in a higher value for:",
    "puts only.",
    "calls only.",
    "both puts and calls.",
    "A",
  ...
  [
    "Consider the following information for a fixed-rate bond:\n\nYield to maturity: 6.57%\nAnnual coupon rate (paid semiannually): 9.00%\nMarket value: $11,189,092\nAnnualized modified duration: 4.687985",
    "If the bond's yield to maturity increases to 7.25%, the bond's estimated market value will be closest to:",
    "$9,746,599.",
    "$10,271,142.",
    "$10,832,403.",
    "B",
  ...
  [
    "One source of return for an investor in a fixed-rate corporate bond is most likely the:",
    "bid-ask spread.",
  ...
  [
    "Which of the following performance measures is only relevant for well-diversified portfolios?",
    "Sharpe ratio",
    "Jensen's alpha",
    "M-squared (M3)",
    "B",
  ...
  [
    "For a coupon bond with a positive yield, compounding more frequently within the year results in a yield-to-maturity that is:",
    "less positive.",
    "the same.",
    "more positive.",
    "A",
  ...
  [
    "Which of the following ESG investment approaches best describes positive screening?",
    "Systematic consideration of material ESG factors in asset allocation",
    "Inclusion of sectors or companies in the portfolio based on specific ESG criteria",
  ...
  [
    ...
    "The price return is 1.26%.",
    "The value of the price return index is 998.1.",
    "The value of the total return index is below 1,000.",
    "B",
  ],
  [
    "An asset-backed securitization with a waterfall structure is most likely structured with which type of credit enhancement?",
    "Subordination",
    "Time tranching",
  ...
  [
    "Which of the following best describes a clawback provision? A provision that:",
    "protects clients from paying twice for the same performance.",
    "reflects the right of limited partners to reclaim part of the general partner's performance fee.",
    "represents the minimum rate of return that must be exceeded in order to earn a performance fee.",
    "B",
  ],
  [
  ...
  [
    "With respect to margin, the leverage ratio:",
    "is the value of the equity investment divided by the value of the position.",
    "is the minimum fraction of the purchase price that must be trader's equity.",
  ...
  [
    "If a bond has a modified duration of 6.2 and convexity of 42.8, the percentage change in price for a 50 basis point increase in yield is closest to:",
    "-3.15%.",
    "-3.05%.",
    "-1.44%.",
    "B",
  ...
  [
    "The capital market line is best described as pricing:",
    "total risk.",
  ...
  [
    "Investors with limited resources and experience enter into alternative investments most likely through:",
    "co-investing.",
    "fund investing.",
    "direct investing.",
    "B",
  ...
  [
    ...
    "spot price of the underlying minus the exercise price of the option.",
    "strike price of the option minus the value of the underlying at expiration.",
    "A",
  ],
  [
    "The acquisition of a public company with the intent to take it private using debt financing best describes:",
    "angel investing.",
  ...
  [
    "An advantage of using price multiples in valuation is most likely that multiples:",
  ...
  [
    "A swap is most likely similar to a series of forward contracts when:",
  ...
  [
    "In a binomial option pricing model, the expected payoff is based on:",
    "estimated probabilities and discounted at the risk-free rate.",
    "risk-neutral probabilities and discounted at the risk-free rate.",
    "risk-neutral probabilities and discounted at the risk-free rate plus a risk premium.",
    "B",
  ],
  [
  ...
  [
    "Which form of market efficiency is most likely tested using technical analysis?",
    "Weak form",
    "Semi-strong form",
    "Strong form",
    "A",
  ...
  [
    ...
    "time horizon.",
    "personality type.",
    "inclination to independent thinking.",
    "A",
  ],
  [
  ...
  [
    "The sum of the coupon payments over a year divided by the flat price of a bond is best defined as:",
    "true yield.",
    "simple yield.",
    "current yield.",
    "C",
  ...
  [
    "In a rising interest rate environment, the effective duration of a putable bond relative to an otherwise identical non-putable bond, will most likely be:",
    "lower.",
    "the same.",
    "higher.",
    "A",
  ...
  [
    "A bond issued by a province is most likely classified as a:",
    "supranational bond.",
  ...
  [
    "An investor owns a stock trading at $22 per share and would like to place an order to sell the position should the stock ever trade at or below $20 per share. The order most likely is:",
    "limit 20 sell.",
    "stop 20, market sell.",
    "stop 20, limit 20 sell.",
    "B",
  ],
  [
    "In relation to asset allocation, which of the following is a desirable property when specifying asset classes?",
    "Asset classes should be mutually exclusive.",
    "An asset class should contain heterogeneous assets.",
    "Each asset class should be composed of assets with low paired correlations.",
    "A",
  ],
  [
    "Based on put-call parity, a fiduciary call can be created by combining:",
    "a long call and a long risk-free zero-coupon bond.",
    "a short put and a long risk-free zero-coupon bond.",
    "a long call and a short risk-free zero-coupon bond.",
    "A",
  ],
  [
    "All else being equal, commodity forward prices will increase as a result of a decrease in the:",
    "risk-free rate.",
    "storage costs.",
    "convenience yield.",
    "C",
  ...
  [
    "As an investor assumes additional risk along the Markowitz efficient frontier, the rate at which expected return increases will most likely:",
    "decrease.",
    "remain constant.",
    "increase.",
    "A",
  ...
  [
    "Which of the following sections of an IPS most likely provides information about specific types of assets to be excluded from a portfolio?",
    "Procedures",
  ...
  [
    "Indifference curves are plotted on a graph, with returns on the vertical axis and risk on the horizontal axis. For a risk-averse investor, the slope of the indifference curve is most likely:",
    "negative.",
    "zero.",
    "positive.",
    "C",
  ...
  [
    "Which of the following most likely facilitates market efficiency?",
    "The presence of arbitrageurs only",
    "The reduction of the number of market participants only",
    "Both the presence of arbitrageurs and the reduction of the number of market participants",
    "A",
  ],
  [
    "The correlation of cryptocurrencies with traditional assets has been:",
    "decreasing.",
    "steady.",
    "increasing.",
    "C",
  ...
  [
    "Which of the following statements is most accurate? Smart beta strategies:",
  ...
  [
    "According to put-call parity, a long position in an underlying is equivalent to a long risk-free bond combined with a:",
    "long call and a long put with the same strike.",
    "long call and a short put with the same strike.",
    "short call and a long put with the same strike.",
    "B",
  ],
  [
    "A mortgage pass-through security most likely has:",
    "stable cash flows.",
    "an uncertain average life.",
    "greater cash flows than the underlying pool of mortgages.",
    "B",
  ],
  [
    "A stock dividend:",
  ...
  [
    "A stock is currently trading at €25.00 and the risk-free rate is 1.75% per annum. The minimum price of a 9-month European call option on the stock with an exercise price of €22.50 is closest to:",
    "€2.21.",
    "€2.50.",
    "€2.79.",
    "C",
  ...
  [
    "The motivation for investing in the mezzanine tranche of a collateralized debt obligation (CDO) is most likely to:",
  ...
  [
    "A member works in a country where there is no regulation relating to investment performance standards. In the absence of any regulatory guidance, the member is required to communicate investment performance information to her clients in accordance with:",
    "the GIPS standards.",
    "the Code and Standards.",
  ...
  [
    ...
    "The local research vendor",
    "The bank-approved research vendor",
    "Both the local and the bank-approved research vendors.",
    "A",
  ],
  [
  ...
  [
    "Jonas Balsys, CFA, has a prospective client, Edith Clancy, who mentions that she donates to environmental causes. Balsys mentions Clancy to a friend who works for an environmental agency. The next week, Balsys prepares an IPS for Clancy. Clancy does not disclose information about assets outside of her ESG investments. Balsys prepares the IPS based on the partial information provided by Clancy and enters into a formal agreement with her. Balsys has most likely violated the Standard relating to:",
    "suitability.",
  ...
  [
    "According to the guidance provided by the Standards, which of the following is not among the recommended procedures for compliance with the Standard relating to independence and objectivity?",
  ...
  [
    "A member receives referral fees for recommending third-party services to clients. Before entering into an agreement with a new client, which of the following is the member required to disclose to the new client?",
    "Flat fees only",
    "Benefits received in soft dollars only",
    "Both flat fees and benefits received in soft dollars",
    "C",
  ],
  [
    "Which of the following is a key concept relating to the GIPS standards? The GIPS standards:",
  ...
  [
    "John Clark, CFA, starts a new job and re-creates a research report on a company he covered at his previous employer. He uses information gathered directly from the covered company. He also uses his personal notes taken while working at his previous employer. Has Clark violated the Standard relating to record retention?",
    "No",
    "Yes, because he uses information he gathered directly from the covered company",
    "Yes, because he uses his personal notes taken while working at his previous employer",
    "C",
  ],
  [
    "Trust is most likely the foundation of the financial industry because:",
    "financial products and services are often tangible and verifiable.",
    "investors rely on the specialized knowledge of investment professionals.",
    "global financial markets and their participants are highly regulated by effective laws.",
    "B",
  ],
  [
    ...
    "revise his research report.",
    "leave his research report as it is.",
    "request the portfolio manager not act on the information.",
    "A",
  ],
  [
    "According to the GIPS standards, which of the following statements is most accurate? Verification:",
  ...
  [
    "Feng Liu, CFA, is an investment manager. Liu organizes nonviolent demonstrations on weekends to fight climate change. After repeated demonstrations, Liu is arrested and convicted for obstructing public transit which is considered an act of civil disobedience in her country. Has Liu violated the Standards?",
    "No",
  ...
  [
    "According to the Standard relating to loyalty, prudence, and care, a member with control of client assets should submit to each client an itemized statement of their security holdings and transactions at least:",
    "quarterly.",
    "semi-annually.",
    "annually.",
    "A",
  ...
  [
    "Preeta Singh, a CFA candidate, is an asset manager employed by a fund management company, which manages very large segregated pension funds. In her spare time outside of working hours, Singh likes to provide strategic planning consulting services to small companies to help grow their businesses. Singh is paid for the consulting services and has also provided her employer information about these outside activities. Has Singh violated the Standards?",
    "No",
    "Yes, the Standard relating to loyalty",
  ...
  [
    'Upon receiving notification that he passed his Level Ill CFA exam, Paulo Garcia updates his educational background on his social media site by adding "completed the CFA course." Does Garcia most likely violate the Standards?',
    "No",
    "Yes, because it could imply he has obtained the charter.",
    "Yes, because he doesn't describe the certification process.",
    "B",
  ],
  [
    ...
    "No",
    "Yes, by using the original analyst's work in the report",
    "Yes, by not attributing the report to the original analyst",
    "A",
  ],
  [
    "According to the Standard relating to responsibilities of supervisors, a member who works as a department head managing large numbers of employees must:",
    "have in-depth knowledge of the Code and Standards.",
    "personally evaluate the conduct of all employees in his department on a continuing basis.",
    "make reasonable efforts to ensure all employees at his firm comply with applicable laws and regulations.",
    "A",
  ],
  [
    "Vai Rajan, CFA, a well-known analyst, issues a buy recommendation on a small-cap stock. Rajan shares his recommendation with the public two days after he shares the recommendation with his clients. The public dissemination leads to a significant increase in the stock price. Lise Genzo, CFA, one of Rajan's clients, buys a large position in the stock. Genzo sells the entire position for a profit after the recommendation is disseminated to the public. Her action leads to a significant decline in the stock price. Do the actions of the two members comply with the Standard relating to market manipulation?",
    "Yes",
    "No, only Rajan's action is compliant",
    "No, only Genzo's action is compliant",
    "A",
  ],
  [
    "Ann Collins, CFA, manages a fund for Kreet Investments (KI). KI provides a retirement plan for employees offering a choice of ten large diversified mutual funds. The choices include two funds managed by KI employees. Collins changes her personal investment allocation to the two funds managed by her colleagues without disclosing the change to KI or to her clients. Has Collins violated the Standard relating to avoid or disclose conflicts?",
    "No",
    "Yes, by failing to disclose the allocation change to KI",
    "Yes, by failing to disclose the allocation change to her clients",
    "A",
  ],
  [
  ...
  [
    "A central bank announcement of a program to raise rates to moderate inflation will most likely lead to:",
    "higher asset prices.",
  ...
  [
    "Deferred tax liabilities could arise when:",
    "accounting profit is greater than taxable income.",
    "the tax base of equipment is greater than its carrying value.",
    "tax authorities do not allow an expense item for tax purposes.",
    "A",
  ],
  [
    "Which of the following statements about dispersion measures is most accurate?",
    "The range shows how the data are distributed",
    "The variance is expressed in the same unit of measurement as the observations",
    "The number of degrees of freedom in estimating the population variance with the sample variance is equal to the sample size minus one",
    "C",
  ],
  [
  ...
  [
    "Which of the following best reflects good corporate governance?",
  ...
  [
    "With respect to fintech applications, data curation is best described as the process of:",
    "ensuring data quality and accuracy.",
    "collecting and transforming data into a format that can be used.",
    "recording, archiving, and accessing data from the underlying database.",
    "A",
  ],
  [
    "An analyst estimates the following risk premiums for a long-term corporate bond: Inflation premium Default risk premium Liquidity premium Maturity premium 1.5% 2.0% 1.0% 1.5% Q. If the short-term nominal risk-free interest rate is 4.0%, the yield on the bond is closest to:",
    "6.0%.",
    "8.5%.",
    "10.0%.",
    "B",
  ...
  [
    ...
    "shorter and shallower than business cycles.",
    "of equal length and depth as business cycles.",
    "longer and deeper than business cycles.",
    "C",
  ],
  [
    "Selected year-end financial data for a company is as follows: Net income Tax rate Weighted average number of common shares outstanding 12% bond convertible into 3,000 common shares (potentially dilutive) Q. Given this information, the diluted EPS of the company is closest to:",
    "$1.51.",
    "$1.60.",
    "$1.61.",
    "B",
  ...
  [
    "An analyst uses the following information to forecast a company's gross profit margin: Sales Cost of sales Current Amount (in $ millions) 1,200 300 Forecasted Growth 40/0 8% Q. The analyst's gross margin forecast would be closest to a(n):",
    "decrease of 4%.",
    "decrease of 1%.",
    "increase of 1%.",
    "B",
  ...
  [
    "An analyst gathers the following one-period continuously compounded returns. 4.2% 3.0% -1.00/0 r2,3 Q. The continuously compounded return from time t = 0 to time t = 3 is closest to:",
    "6.07%.",
    "6.20%.",
    "6.25%.",
    "B",
  ...
  [
    "An analyst gathers the following information about a company: Market value of equity Cost of equity Market value of debt Before-tax cost of debt Marginal tax rate Q. The company's WACC is closest to:",
    "11.02%.",
    "11.50%.",
    "11.86%.",
    "B",
  ...
  [
    "Which of the following is best referred to as a nonparametric hypothesis test concerning correlation? A test using the:",
  ...
  [
    "An exchange rate between two currencies has decreased to 1.3500. If the base currency has depreciated by 7% against the price currency, the initial exchange rate between the two currencies was closest to:",
    "1.2617.",
    "1.4445.",
    "1.4516.",
    "C",
  ...
  [
    "According to Modigliani-Miller propositions, if a profitable company uses more debt in the presence of taxes, firm value will:",
    "decrease.",
    "remain the same.",
    "increase.",
    "C",
  ...
  [
    "A qualified audit opinion is most appropriately issued when:",
    "there is some scope limitation or exception to accounting standards.",
    "the company's financial statements are fairly presented and free from material error.",
    "the company's financial statements materially depart from accounting standards and are not fairly presented.",
    "A",
  ],
  [
    "A credit rating agency assesses a company's corporate governance structure as favorable to creditor rights. The most likely impact of this assessment on the company is a(n):",
    "reduction in its cost of debt.",
    "increase in its risk of default.",
    "reduction in its financial performance.",
    "A",
  ],
  [
    "Which of the following statements about company stakeholders is most accurate?",
  ...
  [
    "In the static trade-off theory of capital structure, when a company's capital structure is optimal, its marginal cost of financial distress is:",
    "less than the marginal benefit of its tax shield.",
    "equal to the marginal benefit its tax shield.",
    "greater than the marginal benefit of its tax shield.",
    "B",
  ],
  [
  ...
  [
    "An analyst runs a simple linear regression using 35 months of data to assess a country's short-term interest rate as a function of its inflation rate, with the following results: Source Degrees of Freedom Sums of Squares Mean Square Regression Error Total 1 33 34 17.3009 20.2299 37.5308 17.3009.6130 Q. The value of the standard error of the estimate is closest to:",
    "0.68.",
    "0.78.",
    "1.05.",
    "B",
  ...
  [
    "An investor turned 25 years old today. She plans to deposit $5,000 in a savings account at the end of each year, with the first deposit to be made one year from today. The last deposit will be made on her 65th birthday. If the annual return is 4%, the total savings on the day of her last deposit will be closest to:",
    "$452,046.",
    "$475,128.",
    "$499,133.",
    "B",
  ...
  [
    "An analyst gathers the following probability distribution of a company's EPS: Probability 0.1 0.9 Q. The standard deviation of EPS is closest to:",
    "$2.4.",
    "$4.0.",
    "$5.8.",
    "A",
  ...
  [
    "Which of the following statements relating to the financial reporting of defined contribution pension plans is correct?",
    ...
    "Defined-contribution plans require companies to make several assumptions in order to estimate their pension obligations",
    "B",
  ],
  [
    "An analyst gathers the following information (in $ millions) about a company: Average total assets Average total liabilities Q. The financial leverage ratio is:",
    "0.6.",
    "1.5.",
    "25",
    "C",
  ...
  [
    "An analyst gathers the following information (in € millions) about three companies: Company 1 Company 2 Company 3 Cash and short-term securities Accounts receivable Inventory Current liabilities Q. The company with the highest quick ratio is:",
    "Company 1.",
    "Company 2.",
    "Company 3.",
    "B",
  ...
  [
    "An analyst gathers the following information about a sample from a population with a lognormal distribution: Sample size Sample mean Sum of squared deviations from the sample mean Q. The standard error of the sample mean is closest to:",
    "0.12.",
    "0.41.",
    "064",
    "A",
  ...
  [
    "An analyst gathers the following observations of a variable: 1.0 2.0 2.0 3.0 4.0 Q. The second quartile of the observations is closest to:",
    "2.0.",
    "2.5.",
    "30",
    "A",
  ...
  [
    "An increase in which of the following accounts could increase the current ratio?",
    "Trade receivables",
    "Accrued expenses",
    "Deferred tax assets",
    "A",
  ...
  [
    "An analyst gathers the following information (in E millions) about a company's expenditures in developing an intangible asset for internal use: Costs incurred during research phase Development costs incurred after reaching technical feasibility 10 15 Q. If all the criteria for capitalization have been met, the maximum amount of expenditures (in E millions) eligible for capitalization is most likely:",
    "10.",
    "15.",
    "25.",
    "B",
  ...
  [
    "An asset management firm generated the following annual returns in their US large-cap equity portfolio: Year 2008 2009 2010 2011 Net Return (%) -34.8 32.2 11.1 -1.4 Q. The 2012 return needed to achieve a trailing five-year geometric mean annualized return of 5% when calculated at the end of 2012 is closest to:",
    "17.9%.",
    "27.6%.",
    "35.2%.",
    "C",
  ...
  [
    "Under the revaluation model, an initial revaluation that increases the carrying amount of assets increases:",
  ...
  [
    "The structural budget deficit is the deficit that exists if the economy:",
  ...
  [
    "All else being equal, during periods of rising prices and constant inventory quantities, a company using the weighted average cost inventory valuation method most likely reports a:",
    "higher gross profit margin than if using FIFO.",
    "lower inventory turnover ratio than if using FIFO.",
    "shorter cash conversion cycle than if using FIFO.",
    "C",
  ],
  [
    "A country which is a global leader and uses its political or economic influence over other countries to control resources is best described as:",
    "autarkic.",
    "multilateral.",
    "hegemonic.",
    "C",
  ...
  [
    ...
    "are created only when crowdsourcing is used.",
    "are present in many older, pre-internet businesses.",
    "C",
  ],
  [
    "In capital investing, a production-flexibility option allows a company to:",
    "reduce supply on lower demand.",
    "sequence investments over time.",
    "increase prices on excess demand.",
    "A",
  ],
  [
    "All else being equal, if interest expense is not tax deductible, as a company's marginal tax rate increases, the company's WACC:",
    "decreases.",
    "remains the same.",
    "increases.",
    "B",
  ...
  [
    "An analyst gathers the following exchange rate information: AUD/USD AUD/EUR Spot rate 1.3889 1.6393 Forward rate 1.3195 1.4875 AUD/USD is the amount ofAUD per 1 USD AUD/EUR is the amount ofAUD per 1 EUR Q. The USD is expected to depreciate against:",
    "the AUD only.",
    "the EUR only.",
    "both the AUD and the EUR.",
    "A",
  ],
  [
    "An analyst examining the statement of cash flows for possible manipulation is least likely to be concerned about a(n):",
  ...
  [
    "A project offers the following incremental after-tax cash flows (CF): Year Cash flow (€) 1 2 -12,500 2,000 4,000 3 5,000 4 2,000 Q. The appropriate discount rate to use in evaluating the project is 8%. The net present value (NPV) of the project is closest to:",
    "-€1,780.",
    "-€1,736.",
    "-€922.",
    "A",
  ...
  [
    "The following data are available on a company: Metric Total assets Total revenues Total expenses Research and development expenses ($ millions) 145 282 241 12 Q. Under a common-size analysis, the value used for research and development expenses is closest to:",
    "4.2%.",
    "5.0%.",
    "8.3%.",
    "A",
  ...
  [
    "The following financial statement data are available for a company: Net income Depreciation Cash flow from operations Free cash flow to the firm Beginning total assets Ending total assets Ending cash balance Book value Q. The company's cash return on assets ratio is closest to:",
    "10%.",
    "12%.",
    "13%.",
    "B",
  ...
  [
    "Which of the following statements is most accurate? Private companies:",
    "are typically subject to registration requirements.",
    "may be restricted to issue securities only to accredited investors.",
    "have little ownership overlap between management and shareholders.",
    "B",
  ],
  [
  ...
  [
    "An analyst gathers the following information: CAD/EUR spot exchange rate CAD 12-month risk-free rate EUR 12-month risk-free rate CAD/EUR is the amount of CAD per 1 EUR. Q. The CAD/EUR 12-month forward points are closest to:",
    "-211.",
    "21.",
    "214.",
    "C",
  ...
  [
    "Which of the following statements regarding indexes for alternative investments is most accurate?",
    "Hedge funds determine whether their results will be included in an index.",
    "Commodity indexes consist of a market-weighted basket of one or more specific commodities",
    "Commodity index returns are based on changes in the prices of the underlying commodities",
    "A",
  ],
  [
    "Which of the following transactions poses the risk of losing the greatest dollar amount?",
  ...
  [
    "When the forward price of a commodity exceeds the spot price, the commodity market is most likely in:",
    "carry.",
    "contango.",
    "backwardation.",
    "B",
  ...
  [
    "Which of the following risk metrics is best used to estimate extreme losses?",
    "Rho",
    "Delta",
    "Conditional VaR",
    "C",
  ...
  [
    "With respect to fintech applications, the instantaneous transfer of collateral in the event of default is an example of:",
    "tokenization.",
    "smart contracts.",
  ...
  [
    ...
    "Buying the stock of a company that is spinning off a subsidiary",
    "Selling stock options to earn premiums and benefit from limited market movements",
    "Taking long positions in undervalued stocks and short positions in overvalued stocks",
    "A",
  ],
  [
    "Which of the following valuation models does not require the estimation of required rate of return on a share?",
    "A price multiple model",
  ...
  [
    ...
    "a portfolio consisting of the underlying and the derivative must earn the risk-free rate.",
    "expected payoffs of the derivative are discounted at the risk-free rate plus a risk premium.",
    "B",
  ],
  [
    "With respect to interest rate changes, if an investor's investment time horizon is longer than the time-to-maturity of a bond, coupon reinvestment risk is:",
    "less important than market risk.",
    "is equally as important as market risk.",
    "more important than market risk.",
    "C",
  ],
  [
    "The duration statistic that best measures the interest rate risk of a bond that does not have a well-defined internal rate of return is:",
    "effective duration.",
    "modified duration.",
    "Macaulay duration.",
    "A",
  ...
  [
    "An analyst forecasts different outcomes for a company next year: Bear Case Sales (In € 280 millions) EBITDA margin 10 Debt to capital 75 Q. This forecast table is best described as a:",
    "scenario analysis.",
    "sensitivity analysis.",
  ...
  [
    "According to the size effect anomaly:",
  ...
  [
    "Which of the following is most likely a consequence of the overconfidence bias? An investor who:",
  ...
  [
    "Which of the following sections of the IPS most likely explains how to respond to various contingencies?",
    "Procedures",
    "Investment guidelines",
  ...
  [
    "The data for two stocks in an index are as follows: Stock Shares Outstanding 5,000 2,000 Percent of Shares in Market Float 90 100 Beginning of Period Price ($) 40 68 End of Period Price ($) 45 60 Dividends per Share ($) 1.00 0.50 Assuming the beginning value of the float-adjusted market-capitalization-weighted equity index is 100, the ending value is closest to:",
    "102.06.",
    "102.68.",
    "103.80.",
    "A",
  ...
  [
    "An assumption of the CAPM is that:",
    "markets are frictionless.",
    "investors are risk-neutral.",
    "an investor's trades affect prices.",
    "A",
  ],
  [
    "Which of the following factors is most appropriate to consider when determining a company's risk tolerance?",
    "The company's positioning within its industry",
    "The beliefs of the company's board members",
    "The short-term stability of the market environment",
    "A",
  ],
  [
  ...
  [
    "Debtor-in-possession (DIP) financing refers to financing for firms:",
    "already in bankruptcy.",
    "at the risk of bankruptcy without additional financing.",
    "with strong financial positions and promising growth prospects.",
    "A",
  ],
  [
  ...
  [
    ...
    "investors start receiving repayments.",
    "overcollateralization begins to be reduced.",
    "repaid principal is reinvested in loans of equal principal.",
    "C",
  ],
  [
    "Which of the following statements regarding rebalancing and reconstitution of an index is most accurate?",
    "Market-capitalization-weighted indexes require frequent rebalancing.",
    "Reconstitution can dramatically affect prices of both current and prospective constituents.",
    "Reconstitution is part of index management that reduces the need for rebalancing.",
    "B",
  ],
  [
    "An analyst gathers the following information for a portfolio of annual pay bonds: Par value Time to maturity Coupon Yield Market value Macaulay duration Bond A 4 years 4% 4.27% 3.774 Bond B 7 years 5.5% 6.18% $7,698,251.78 5.973 Bond C 10 years 6.25% 7.2% $11 7.639 Q. The average (annual) modified duration of the portfolio is closest to:",
    "5.19.",
    "5.23.",
    "551",
    "A",
  ...
  [
    "Based on put-call parity, a trader can replicate the payoff of a long call by creating a portfolio consisting of a:",
    "long put, a long asset, and a long bond.",
    "long put, a long asset, and a short bond.",
    "short put, a short asset, and a long bond.",
    "B",
  ],
  [
    "An analyst gathers the following information about US bonds: Bond US government benchmark bond US corporate bond Coupon Rate 2.0% 5.0% Price 101 103 Years to Maturity 2 2 Q. Assuming annual interest payments, the G-spread is closest to:",
    "149 basis points.",
    "193 basis points.",
    "300 basis points.",
    "B",
  ...
  [
    "Which of the following is most advantageous to the general partner of a private equity fund assuming no clawback provision?",
    "American waterfall",
    "European waterfall",
  ...
  [
    "An analyst gathers the following data for a 2-year option contract: Forward price Strike price Risk-free rate Call premium USD/EUR is the amount of USD per 1 EUR Q. The put premium is closest to:",
    "0.0273 USD/EUR.",
    "0.0727 USD/EUR.",
    "0.0750 USD/EUR.",
    "B",
  ...
  [
    "Which of the following is least likely one of the main benefits of derivative markets? Derivative markets:",
  ...
  [
    "If a stock is purchased on margin where the minimum margin requirement is 35%, the maximum leverage ratio is closest to:",
    "1.54.",
    "1.86.",
    "2.86.",
    "C",
  ...
  [
    "An investor analyzes the stock market of a specific country and discovers that the stock prices are very slow to reflect new information. The investor can best profit from this situation using a(n):",
    "active fund.",
    "passive fund.",
    "low cost approach.",
    "A",
  ...
  [
    "The option-free bonds issued by ALS Corp. are currently priced at 108.50. Based on a portfolio manager's valuation model, a 1 bp increase in interest rates will result in the bond price falling to 108.40, whereas a 1 bp decrease in interest rates will result in the bond price rising to 108.59. The price value of a basis point (PVBP) for the bonds is closest to:",
    "0.088.",
    "0.095.",
    "0.190.",
    "B",
  ...
  [
    "Over-the-counter derivatives markets most likely have a lower degree of:",
    "privacy than exchange-traded derivatives markets.",
    "flexibility than exchange-traded derivatives markets.",
    "transparency than exchange-traded derivatives markets.",
    "C",
  ],
  [
    "An analyst gathers the following information about a company: ROA Leverage ratio Dividend payout ratio Q. The sustainable growth rate is closest to:",
    "3.4%.",
    "5.2%.",
    "6.2%.",
    "C",
  ...
  [
    "Which of the following statements about alternative investments' compensation structures is most accurate?",
  ...
  [
    "Which of the following statements about endowments and foundations is most accurate?",
    "Most endowments and foundations have relatively short time horizons.",
    "Endowments typically allocate a sizable portion of their assets in alternative investments.",
    "Foundations are funds of non-profit institutions that help the institutions provide designated services.",
    "B",
  ],
  [
    "If the expected return on the market portfolio is 6% and the risk-free rate is 2%, the expected return of a security with a beta of 1.25 is closest to:",
    "5.00%.",
    "7.00%.",
    "9.50%.",
    "B",
  ...
  [
    "An investor gathers the following information about a company: Current earnings per share Current dividend per share Required rate of return Return on equity (ROE) $5.00 $3.00 15.0% 17.5% Q. Using the dividend discount model, the value of the company's stock is closest to:",
    "$37.50.",
    "$40.13.",
    "$73.67",
    "B",
  ...
  [
    "Which of the following best describes a feature unique to the co-investing method of investing in alternative assets? A limited partner:",
    "participating in an investment fund alongside other limited partners.",
    "making an investment alongside a fund in a deal the fund has identified.",
    "participating in an investment fund that invests in deals identified and managed by the general partner.",
    "B",
  ],
  [
    "With respect to return-generating models for stock returns, the three-factor model of Fama and French includes which of the following factors? Relative:",
    "earnings growth",
  ...
  [
    "Which of the following statements about mutual funds is most accurate?",
    "Open-end funds tend to be fully invested without keeping cash.",
    "Closed-end funds can sell for a premium or discount to net asset value.",
    "Investors in a closed-end fund liquidate by selling their shares back to the fund itself.",
    "B",
  ],
  [
    "Forward rate agreements can be used by firms to:",
    "lock in a fixed borrowing or lending rate at a future date.",
    "pay the return on an equity index and receive a fixed rate.",
    "hedge against exchange rate fluctuations in foreign-currency investments.",
    "A",
  ],
  [
    "Accrued interest:",
    "depends on a bond's yield-to-maturity.",
    "is equal to a bond's full price minus its flat price.",
    "is typically included in the price quoted by bond dealers.",
    "B",
  ],
  [
  ...
  [
    "Which of the following objectives of a client's IPS is best described as a relative risk objective? For the next year, a client's portfolio objective is to:",
    "have a 95% value at risk that is less than $100,000.",
    "outperform the local stock market index by 100 basis points.",
    "earn a return within plus or minus 2 percentage points of the local stock market index return.",
    "C",
  ],
  [
    "In addition to investing in core real estate, a real estate private equity fund following a core-plus strategy most likely invests in properties with:",
    "slightly less leasing risk than a core strategy.",
    "the same level of leasing risk as a core strategy.",
    "slightly more leasing risk than a core strategy.",
    "C",
  ],
  [
    "A correlation matrix of the returns for securities A, B, and C is reported below: Security c 1 0.5 0 1 -0.5 c 1 Q. Assuming that the expected return and the standard deviation of each security are the same, a portfolio consisting of an equal allocation of which two securities will be most effective for portfolio diversification?",
    "Securities A and B",
    "Securities A and C",
    "Securities B and C",
    "C",
  ...
  [
    "An investor purchases common shares at €22 per share on margin and deposits just enough money to cover the 60% initial margin requirement. If the maintenance margin requirement is 25%, the share price below which the investor will first receive a margin call is closest to:",
    "€11.73.",
    "€16.50.",
    "€17.60.",
    "A",
  ...
  [
    ...
    "have balloon maturities.",
    "have amortizing principal.",
    "do not have call protection.",
    "A",
  ],
  [
    "Expected future benefits to be received from a common share are most likely an important input for a(n):",
    "multiplier model.",
    "asset-based model.",
    "present value model.",
    "C",
  ...
  [
    "Which of the following is used by clearinghouses to determine the daily gain and loss to the parties of a futures contract?",
    "Mark to market",
    "Maintenance margin",
    "Limit up and limit down",
    "A",
  ...
  [
    "Compared to investing in a single security, the portfolio approach can improve investors' risk—return trade-off by offering:",
  ...
  [
    "When buying a stock, a limit order is more likely to be:",
    "executed faster than a market order.",
    "completely filled than a market order.",
    "executed at lower prices than a market order.",
    "C",
  ],
  [
    "Which of the following is most likely associated with secondary capital markets?",
    "Book building",
    "Continuous trading",
    "Lead underwriters",
    "B",
  ...
  [
    "Price multiples allow for:",
    "time series comparisons only.",
    "cross-sectional comparisons only.",
    "both time series and cross-sectional comparisons.",
    "C",
  ],
  [
    "With respect to the absolute priority of claims in bankruptcy, which of the following most likely has the highest seniority ranking?",
    "Third lien debt",
    "Subordinated debt",
  ...
  [
    "For portfolios composed of the risk-free asset and a risky asset, the expected return as a function of standard deviation of returns is graphically represented by the:",
  ...
  [
    "An analyst gathers the following information about a company (in $ thousands): Operating income Depreciation and amortization Interest expense Year 1 255 432 170 Year 2 234 677 156 Q. Based on the interest coverage ratio using EBITDA, the company's creditworthiness has:",
    "deteriorated.",
    "remained unchanged.",
    "improved.",
    "C",
  ...
  [
    "Which of the following is most likely used by private equity funds?",
    "Leveraged buyouts",
  ...
  [
    "The minimum rate of return required by investors to purchase an equity security is most likely approximated by the company's:",
    "cost of equity.",
    "return on equity.",
  ...
  [
    "Which of the following is most likely a means of executing a differentiation competitive strategy?",
    "Trademarks",
    "Economies of scope",
    "Geographical proximity to its customers",
    "A",
  ],
  [
  ...
  [
    "The first date a buyer of shares is not entitled to an announced dividend is the:",
    "declaration date.",
    "ex-dividend date.",
    "holder-of-record date.",
    "B",
  ...
  [
    "When defining an asset class for the purpose of asset allocation, an investor should ensure that assets in the class are relatively:",
    "homogeneous and have low paired correlations with other asset classes.",
    "homogeneous and have high paired correlations with other asset classes.",
    "heterogeneous and have low paired correlations with other asset classes.",
    "A",
  ],
  [
  ...
  [
    ...
    "always positive.",
    "negative for a decrease in yield.",
    "negative for an increase in yield.",
    "A",
  ],
  [
  ...
  [
    "When securitizing a corporation's loans, a special purpose entity most likely:",
    "services the corporation's loans.",
    "sells the collateral underlying the corporation's loans.",
    "purchases the corporation's loans to use as collateral.",
    "C",
  ],
  [
    "The sensitivity of a putable bond to a flattening of the yield curve is best measured by:",
    "key rate duration.",
    "effective duration.",
    "modified duration.",
    "A",
  ...
  [
    "A consequence of preventing the exploitation of private information is that the market is not:",
    "weak-form efficient.",
  ...
  [
    "A bond has a modified duration of 7.5 years and an annual convexity of 280. If yields decrease by 60 basis points, the percentage price change is closest to:",
    "4.00%.",
    "5.00%.",
    "5.51%.",
    "B",
  ...
  [
    "In the binomial model, if the probability of a downward movement in an underlying increases, the value of a call option:",
    "decreases.",
    "remains unchanged.",
    "increases.",
    "B",
  ...
  [
    "Returns adjusted for the total risk of a portfolio relative to a benchmark are most appropriately measured using which of the following?",
    "M-squared",
    "Treynor ratio",
    "Jensen's alpha",
    "A",
  ...
  [
    "Over a given holding period, performance of credit-risky bonds will most likely benefit from:",
  ...
  [
    "Which of the following US sovereign securities is a pure discount bond?",
    "Treasury bill",
    "Treasury note",
    "Treasury bond",
    "A",
  ...
  [
    ...
    "young and just entering the growth phase.",
    "mature and relatively insensitive to economic fluctuations.",
    "experiencing growth that is higher than the sustainable growth rate.",
    "B",
  ],
  [
  ...
  [
    "The value of a call option is inversely related to the:",
    "risk-free rate.",
    "exercise price.",
  ...
  [
    ...
    "market price risk is greater than coupon reinvestment risk.",
    "coupon reinvestment risk is greater than market price risk.",
    "B",
  ],
  [
    "If a hedge fund imposes a gate, it is temporarily limiting the:",
  ...
  [
    "Financial instruments trade for delivery in:",
    "spot markets only.",
    "forward markets only.",
    "both spot and forward markets.",
    "C",
  ],
  [
    "Toshi Hoda, CFA, is an analyst at a brokerage firm. Hoda holds shares in a company that he begins to cover. According to the Standard relating to avoid or disclose conflicts, Hoda is required to disclose his personal holdings to:",
    "his employer only.",
  ...
  [
    "According to the Standard related to communication with clients and prospective clients, members must:",
  ...
  [
    ...
    "No",
    "Yes, Action 1 is a violation of the Standard",
    "Yes, Action 2 is a violation of the Standard",
    "A",
  ],
  [
  ...
  [
    "David Jacobs, CFA, and Megan Amari, CFA, work for Global Investment Inc. and receive fees for client referrals. Prior to signing service agreements with clients, Jacobs informs his clients about the referral fee arrangement without providing an estimated dollar value. Amari discloses all details of the arrangement, including the estimated dollar value, to her clients only after the service agreements are signed. Who has violated the Standards?",
    "Amari only",
    "Jacobs only",
  ...
  [
    "Which of the following statements is accurate according to the GIPS standards? Statement 1: A firm must perform verification to claim compliance with the GIPS standards. Statement 2: Verification ensures accuracy of specific composite presentations. Statement 3: Verification is performed with respect to an entire firm.",
    "Statement 1",
    "Statement 2",
    "Statement 3",
    "C",
  ...
  [
    "To comply with the Standard relating to knowledge of the law, members are required to take which of the following actions? Action 1: Acquire detailed knowledge of all the laws relating to their activities Action 2: Dissociate from activities of others that they believe are unethical",
    "Action 1 only",
    "Action 2 only",
    "Both Action 1 and Action 2",
    "B",
  ...
  [
    ...
    "uses public information to implement trading strategies with an intent to exploit perceived market inefficiencies.",
  ...
  [
    ...
    "conforms to expectations as laid out by laws and regulations.",
    "is perceived to be beneficial as per society's ethical expectations.",
    "simply considers both the direct benefit and indirect consequences on others.",
    "B",
  ],
  [
    'Judith Sway has passed the Level I CFA exam. She writes in her resume: "l enrolled in the CFA Program to obtain the highest set of credentials in the global investment management industry." She adds: "The skills the CFA Program cultivates are key assets for my future career development." Has Sway most likely violated the Standards?',
    "No",
    'Yes, by stating: "The skills the CFA Program cultivates are key assets for my future career development."',
    'Yes, by stating: "l enrolled in the CFA Program to obtain the highest set of credentials in the global investment management industry."',
    "A",
  ],
  [
  ...
  [
    "According to the Standard relating to misrepresentation, a member is most likely required to:",
  ...
  [
    "Tyler Cowen, CFA, retains all records relating to recommendations to buy or sell a security, but discards all notes that do not lead to a change in recommendations. Cowen's colleague Marie Thomsen, CFA, maintains all her records in electronic form but does not retain hard copies for some of her recommendations. Who has most likely violated the Standard relating to record retention?",
    "Cowen only",
    "Thomsen only",
  ...
  [
    "Which of the following claims can an asset management firm most likely make regarding the GIPS standards?",
  ...
  [
    "Which of the following is a recommended procedure for compliance with the Standard relating to responsibility of supervisors? Members should encourage their firms:",
    "only to provide their code of ethics to clients.",
    "only to mingle their code of ethics with their compliance procedures.",
    "both to provide their code of ethics to clients and to mingle their code of ethics with their compliance procedures.",
    "A",
  ],
  [
  ...
  [
    "Which of the following is not a requirement of the GIPS standards? Firms are required to:",
  ...
  [
    "To claim compliance with the GIPS standards, a firm that has been in existence for two years must:",
  ...
  [
    ...
    "present the performance using a single representative account.",
  ...
  [
    "Immediately after taking the CFA Level II exam, Tim Riley posts on social media broad topic areas that were not tested on the exam. He also posts an article on social media questioning the relevance of CFA Program for professional practice. Has Riley violated the Standards?",
    "No",
  ...
  [
    "Which of the following is a recommended procedure for compliance with the Standard relating to diligence and reasonable basis? Members should encourage their firms to:",
  ...
  [
    "A portfolio invested in two assets has an expected return of 11%. If expected returns for Assets A and B, respectively, are 8% and 12%, then the portfolio weight of Asset B is closest to:",
    "25%.",
    "50%.",
    "75%.",
    "C",
  ...
  [
    "A company plans to do an upward revaluation of an asset under the revaluation model. All else being equal, the company's debt-to-assets ratio will:",
    "decrease.",
    "remain unchanged.",
    "increase.",
    "A",
  ...
  [
    "Capital restrictions most likely:",
  ...
  [
    "An individual can invest $19,000 today and receive $20,000 in one year's time. If her required rate of return is 5%, the rate of return on the investment is:",
  ...
  [
    "A portfolio has a mean return of 2.2% and a standard deviation of returns of 2.5%. If the specified minimum target return is 2.2%, the sample target semideviation is:",
    "less than 2.5%.",
    "equal to 2.5%.",
    "greater than 2.5%.",
    "A",
  ...
  [
    "A company uses both debt and equity financing as part of its capital structure. If the government reduces the corporate tax rate, the company's WACC will:",
    "decrease.",
    "remain the same.",
    "increase.",
    "C",
  ...
  [
    "An analyst examines the distribution of portfolio returns in bullish and bearish market scenarios. To calculate the expected return on the portfolio in a bearish market scenario, the most appropriate approach is to use:",
  ...
  [
    ...
    "is sensitive to changes in the firm's WACC.",
  ...
  [
    "Which is the first step in the standard process of hypothesis testing?",
    "Collect data",
  ...
  [
    "An analyst computes the following analysis of variance (ANOVA) table for a simple linear regression: Source Regression Error Total Sum of Squares 144 48 192 Degrees of Freedom 1 4 5 Mean Square 144 12 Q. The standard error of the estimate for the regression is closest to:",
    "3.5.",
    "6.9.",
    "12.0.",
    "A",
  ...
  [
    "Ensuring that the composition of a board of directors is aligned with a company's governance principles is most likely a responsibility of the:",
    "risk committee.",
    "audit committee.",
  ...
  [
    "Which of the following strategies is most common in business-to-business markets where the universe of potential customers is relatively small and easily reached?",
    "Direct sales",
    "Omnichannel",
    "Traditional channel",
    "A",
  ...
  [
    "A portfolio manager considers the following joint probability function: Return on Foreign Portfolio Return on Foreign Currency Rc = -15% Rc = 30% Rp = -10% 0.6 Rp = 25% 0 0.4 Q. The covariance (in% squared) between the returns on the foreign portfolio and the foreign currency is closest to:",
    "294.",
    "378.",
    "819",
    "B",
  ...
  [
    "Which of the following methods is most appropriate to assess the impact of a geopolitical risk?",
    "Groupthink",
    "Scenario analysis",
    "Linear quantitative modeling",
    "B",
  ],
  [
    "The archetype of country behavior most likely characterized by globalization and cooperation is:",
    "hegemony.",
    "bilateralism.",
    "multilateralism.",
    "C",
  ...
  [
    "According to the pecking order theory of capital structure, managers prefer:",
    "public debt over private debt.",
    "public equity over public debt.",
    "internal financing over private debt.",
    "C",
  ],
  [
    "Which of the following statements best describes the effect of finance leases on financial statements?",
  ...
  [
    "An analyst is comparing the solvency of a company over the past two years using the information below: Year 2 Total debt Total shareholders' equity Total assets Net income Interest payments/interest expense Taxes paid Ratios in Year 1 Debt to capital Interest coverage Millions 2,300 17,000 20,000 375 200 125 12.7% 2.9 Q. The best conclusion the analyst can make about Year 2 is that compared with Year 1, the company's solvency has:",
  ...
  [
    "An analyst gathers the following USD/GBP exchange rate information: USD/GBP spot rate USD/GBP I-year forward rate USD/GBP is the amount of USD per 1 GBP. Q. The I-year forward points are closest to:",
    "1.2.",
    "13.0.",
    "25.0.",
    "B",
  ...
  [
    "An analyst gathers the following information to test whether the population correlation coefficient equals zero: Sample correlation coefficient Sample size Q. The test statistic is closest to:",
    "2.3.",
    "2.5.",
    "2.7.",
    "A",
  ...
  [
    "Which of the following fiscal policy tools is an automatic stabilizer?",
    "Capital expenditures",
    "Social benefits through transfer payments",
  ...
  [
    "Credit cycles:",
    "can amplify business cycles.",
    "are defined as fluctuations in real GDP.",
    "tend to be shorter than business cycles.",
    "A",
  ],
  [
    "If a company raises its prices to consumers, which of the following is most likely to result in an increase in total revenue of the company?",
  ...
  [
    "A central bank is least likely to:",
  ...
  [
    "An analyst gathers the following fiscal year information (in millions) for a company: Cash flow from operating activities Purchase of equipment Sale of equipment Long-term debt repayment Increase in short-term borrowing Q. FCFE is closest to:",
    "million.",
    "million.",
    "million.",
    "C",
  ...
  [
    "A form of economic integration that allows free movement of goods, services, and factors of production among member countries and has a common trade policy against non-members best describes a:",
    "free trade area.",
    "customs union.",
    "common market.",
    "C",
  ...
  [
    "Private companies most likely have:",
  ...
  [
    ...
    "assume no new competition in the marketplace.",
    "incorporate sunk costs in the investment analysis.",
    "ignore the impact of an investment on short-term accounting numbers.",
    "C",
  ],
  [
    "An investment makes ten payments of $10,000 per year, with the first payment today. If the annual discount rate is 6%, the present value of the investment is closest to:",
    "$72,098.",
    "$73,601.",
    "$78,017.",
    "C",
  ...
  [
    "In monopolistic competition, the level of output that minimizes average cost is:",
    "less than the actual level of output in the long run.",
    "equal to the actual level of output in the long run.",
    "greater than the actual level of output in the long run.",
    "C",
  ],
  [
  ...
  [
    "Debt as a proportion of total capital is most likely greatest in which of the following life-cycle stages of a company?",
    "Start-up",
    "Growth",
    "Mature",
    "C",
  ...
  [
    "Which of the following changes to compensation packages would most likely result in management becoming more risk averse in its corporate decision making?",
  ...
  [
    ...
    "work for the company or the industry in which the company operates.",
    "B",
  ],
  [
    "An analyst collects the following information about a company: Net profit margin 4% Return on average assets 8% Return on average equity 16% Revenue €2,500,000 Q. The company's:",
  ...
  [
    "The following table summarizes income statement data for a manufacturing company (in € thousands): Net revenue Cost of goods sold Gross profit Selling, general administrative expense Operating income Interest expense Pre-tax income Income tax Net income Year 2 2,611 1,700 930 295 635 55 580 155 425 Year 1 2,325 1,550 775 260 515 55 460 120 340 Q. Compared with Year 1, the Year 2 common-size income statement may indicate:",
    "a lower tax rate.",
  ...
  [
    "An analyst gathers the following information about a company: Book value of debt Market value of debt Share price Shares outstanding Cost of equity Cost of debt Tax rate Q. Based on this information, the company's WACC is closest to:",
    "6.16%.",
    "6.40%.",
    "6.51%.",
    "A",
  ...
  [
    "In contrast to non-probability sampling, probability sampling:",
  ...
  [
    "A random variable Y = exp(X) is lognormally distributed, where Xis normally distributed. The distribution of Y:",
    "is skewed to the left.",
    "is often used to model stock prices.",
    "has a mean equal to exp(p), where p is the mean of X.",
    "B",
  ],
  [
  ...
  [
    "In an economy with long-run expected inflation of 3% and a real trend rate of growth of 2%, the neutral policy rate is closest to:",
    "1%.",
    "3%.",
    "5%.",
    "C",
  ...
  [
    "Private contracts, such as bank loan agreements, are most likely to provide an effective disciplinary mechanism to ensure high financial reporting quality because:",
    ...
    "loan covenants may allow the lender to recover all or part of their investment if certain financial conditions are triggered.",
    "A",
  ],
  [
  ...
  [
    ...
    "not subjected to impairment testing.",
    "tested at least annually for impairment.",
    "only tested for impairment if there is an indication of impairment.",
    "B",
  ],
  [
    "The multiple of invested capital (MOIC) measure takes into account:",
  ...
  [
    "If the Macaulay duration and time-to-maturity of a bond are equal, the bond is most likely a:",
    "zero-coupon bond.",
    "coupon bond trading at par.",
    "coupon bond trading at a premium.",
    "A",
  ],
  [
    "An example of a negative bond covenant is a:",
    "promise to pay required taxes.",
    "limit on the issuance of additional debt.",
    "requirement to comply with existing laws and regulations.",
    "B",
  ],
  [
  ...
  [
    'An investor makes the following statements: Statement 1: "Swaps are contingent claims." Statement 2: "Swaps are characterized by a series of cash flows." Q. Which of the statements is correct?',
    "Statement 1 only",
    "Statement 2 only",
    "Both Statement 1 and Statement 2",
    "B",
  ...
  [
    "Convenience yield is best described as the:",
    "opportunity cost of the money invested.",
    "nonmonetary advantage of holding the asset.",
    "net of the costs and benefits of holding an asset.",
    "B",
  ],
  [
    "According to the capital asset pricing model (CAPM), the difference in the expected returns for two securities is determined by the securities':",
    "total risk.",
  ...
  [
    ...
    "underlying cash flows only.",
    "expected price appreciation only.",
    "both underlying cash flows and expected price appreciation.",
    "B",
  ],
  [
    "Short positions have the potential for:",
    "unbounded gains only.",
    "unbounded losses only.",
    "both unbounded gains and unbounded losses.",
    "B",
  ],
  [
    "For a given currency and tenor, a bond's yield spread over the standard swap rate is best described as the:",
    "I-spread.",
    "G-spread.",
    "Z-spread.",
    "A",
  ...
  [
    "A disadvantage of computing the duration of a bond portfolio as a weighted average of time to receipt of the aggregate cash flows is that it:",
  ...
  [
    "The money duration of a bond is best defined as:",
  ...
  [
    "A portfolio manager plans to add three securities with the following characteristics to a well-diversified portfolio: Security 1 has the highest Jensen's alpha; Security 2 has the highest information ratio; Security 3 has the lowest nonsystematic variance. Q. To maximize the portfolio's risk-adjusted return, the manager should assign the highest relative weight to:",
    "Security 1.",
    "Security 2.",
    "Security 3.",
    "B",
  ...
  [
    "In the private debt market, a hybrid loan structure that combines secured and unsecured debt into a single loan with a blended interest rate is best described as:",
    "unitranche debt.",
    "mezzanine debt.",
    "a leveraged loan.",
    "A",
  ...
  [
    "All else being equal, credit spreads most likely widen:",
    "in periods of heavy new issue supply.",
    "with expectations of a stronger economy.",
    "with increased demand for corporate bonds.",
    "A",
  ],
  [
  ...
  [
    "An analyst gathers the following information about two assets: Asset 1 expected return -5%, standard deviation of returns 5%; Asset 2 expected return 5%, standard deviation of returns 8%. Q. If the correlation between the two assets' returns is -1, the standard deviation of returns for an equally weighted portfolio of the assets is closest to:",
    "0.04%.",
    "2%.",
    "4%.",
    "B",
  ...
  [
    "If ten board directors are to be elected, under statutory voting, the maximum number of votes a shareholder owning ten shares can cast in favor of a single candidate is:",
    "1.",
    "10.",
    "100.",
    "B",
  ...
  [
    "In the binomial model, if the probability of an upward movement in an underlying increases, the value of a put option:",
    "decreases.",
    "remains unchanged.",
    "increases.",
    "B",
  ...
  [
    "A limit order is an example of a(n):",
  ...
  [
    ...
    "The price ofa swap at initiation is zero as there is no initial outlay of cash",
    "A",
  ],
  [
  ...
  [
    ...
    "An increase in arbitrage opportunities",
    "An increase in the number of market participants",
    "An increase in rules and regulations that promote financial disclosure",
    "A",
  ],
  [
    "Which of the following provides the best behavioral explanation of the value stock anomaly?",
    "The halo effect",
  ...
  [
    "Which of the following equations best describes put-call parity for European options?",
    "po = co - So + X/(1 + r)^T",
    "co = po - So - X/(1 + r)^T",
    "So = co - po - X/(1 + r)^T",
    "A",
  ...
  [
    "An analyst gathers the following information: Bond 1 Bond 2 Time to Maturity 4 years 7 years Yield to Maturity 3.3% 5.1% Q. Based only on this information, the estimated market discount rate for a 6-year bond with similar credit quality is:",
    "3.9%.",
    "4.2%.",
    "4.5%.",
    "C",
  ...
  [
    "Which of the following is least likely a feature of a credit card receivable asset-backed security (ABS)?",
    "A lockout period",
  ...
  [
    "If the correlation between assets in a two-asset portfolio is less than one, the standard deviation of the portfolio is:",
    "less than the weighted average standard deviation of the individual assets.",
    "equal to the weighted average standard deviation of the individual assets.",
    "greater than the weighted average standard deviation of the individual assets.",
    "A",
  ],
  [
    "Return-generating models are best used to estimate the:",
  ...
  [
    "If the forward price of a stock is equal to the current spot price, the price of an at-the-money put option applying put— call parity will be:",
    "lower than the price of at-the-money call option.",
    "equal to the price of at-the-money call option.",
    "higher than the price of at-the-money call option.",
    "B",
  ],
  [
    "In which form of market efficiency do security prices fully reflect private information?",
    "Weak-form efficient",
  ...
  [
    "The bond equivalent yield for a semiannual pay bond is most likely:",
    "equal to the effective annual yield.",
    "more than the effective annual yield.",
    "equal to double the yield per semiannual period.",
    "C",
  ],
  [
    "The focus strategy is most likely used to defend against which of Porter's five forces?",
    "Industry rivalry",
  ...
  [
    "An analyst gathers the following information about spot rates: Time to Maturity 1 year 2 years 3 years Q. For a 3-year, 2% annual coupon payment bond, the price using Sequence 1 is:",
  ...
  [
    "The Procedures section of an investment policy statement (IPS) most likely:",
    "explains the steps to keep the IPS current.",
    "provides information about the permissible use of leverage.",
    "details the investor's policy with respect to rebalancing asset class weights.",
    "A",
  ],
  [
  ...
  [
    "The Macaulay duration of a non-callable perpetual bond with a yield in perpetuity of 8% is closest to:",
    "7.4.",
    "80",
    "135",
    "C",
  ...
  [
    "A bond has an annual modified duration of 2.741, an annual convexity of 22.638, and is currently yielding 5.0%. If the bond's yield-to-maturity decreases to 4.2%, the expected percentage price change is closest to:",
    "-2.12%.",
    "2.27%.",
    "2.34%.",
    "B",
  ...
  [
    ...
    "A twelve-month 95% value at risk of less than €1",
  ...
  [
    "An investor sells a European put option with the following characteristics: Put price Exercise price Q. If the price of the underlying at expiration is 1,670, the profit for the seller is:",
    "20.",
    "30.",
    "50 50 1,640",
    "C",
  ...
  [
    "Individual investors most likely bear investment risk when participating in:",
  ...
  [
    ...
    "The operations and decisions of the fund are controlled solely by the limited partners",
    "The partnership between the general partner and the limited partners is governed by a limited partnership agreement",
    "Additional regulatory and tax reporting requirements due to a limited partner's unique circumstances are documented in the limited partnership agreement",
    "B",
  ],
  [
    "Among three otherwise comparable bonds, the bond with the highest price is most likely to be:",
    "putable.",
    "callable.",
    "option-free.",
    "A",
  ...
  [
    "All else being equal, the price of a commodity futures contract will most likely decrease with a(n):",
  ...
  [
    "An analyst gathers the following estimates about a company: Earnings retention rate 40%; Growth rate 3%. Q. If the justified forward P/E is 10 based on the Gordon growth model, the required rate of return is:",
    "6%.",
    "7%.",
    "9%.",
    "C",
  ...
  [
    "A value-weighted equity index is most likely biased by a stock that:",
    "has a high price.",
    "splits frequently.",
  ...
  [
    "An investor buys a call option for $5 with an exercise price of $100 when the underlying price is $99. The value to the call option buyer if the price of the underlying is $108 at expiration is:",
    "$3.",
    "$4.",
    "$8.",
    "C",
  ...
  [
    "Which of the following measures is an example of a top-down driver for forecasting a firm's revenue?",
    "Same-store sales growth",
    "Growth relative to GDP growth",
    "Volumes and average selling prices",
    "B",
  ],
  ["Only the seller can default on a(n):", "swap.", "option.", "forward.", "B"],
  [
    "Which of the following statements about REITs is most accurate?",
    "Adding real estate to a portfolio of traditional investments will increase portfolio risk",
    "Adding real estate to a portfolio of traditional investments will decrease portfolio diversification",
    "Equity REIT correlations with traditional investments are at their highest during steep market downturns",
    "C",
  ],
  [
    "An analyst gathers the following information about a stock purchased on margin: Purchase price of stock Leverage ratio Price below which first margin call received Q. The maintenance margin requirement is:",
    "20%.",
    "25%.",
    "40%.",
    "B",
  ...
  [
    "At maturity, the buyer of an over-the-counter (OTC) financial instrument faces the counterparty credit risk of the seller in:",
  ...
  [
    "Which of the following are most likely traded in traditional investment markets?",
    "Commodities",
    "Securitized debts",
  ...
  [
    "A 5% semiannual pay bond with a par value of $1,000 is priced for settlement on February 5. If interest payments are made on May 31 and November 30, accrued interest based on 30/360 day-count convention is closest to:",
    "$9.03.",
    "$9.18.",
    "$9.31.",
    "A",
  ...
  [
    "The value of a European put option is inversely related to the:",
    "risk-free rate.",
    "exercise price.",
  ...
  [
    "With respect to risk management, determining how risk is taken by an organization best describes:",
    "risk tolerance.",
    "risk mitigation.",
    "risk budgeting.",
    "C",
  ...
  [
    "Which of the following measures is least appropriate for evaluating the risk of a currency option?",
    "Beta",
    "Vega",
    "Delta",
    "A",
  ...
  [
    "Enterprise value equals the market value of a company's debt and equity reduced by the company's:",
    "debt.",
    "cash.",
    "preferred stock.",
    "B",
  ...
  [
    "With respect to behavioral finance, an explanation for the overreaction anomaly is:",
    "risk aversion.",
    "loss aversion.",
    "sudden changes in economic fundamentals.",
    "B",
  ],
  [
  ...
  [
    "An analyst gathers the following information about a company and its common stock: Current dividend per share (Do) Dividend payout ratio ROE Q. If the required return is 8%, the intrinsic value per share using the Gordon growth model is closest to: $2.00 55% 9%",
    "$50.63.",
    "$52.68.",
    "$68.82.",
    "B",
  ...
  [
    "Which of the following components of an investment policy statement most likely states a client's requirements for withdrawing funds from the portfolio?",
  ...
  [
    "All else being equal, a stock dividend most likely:",
    "decreases the share price.",
    "has no impact on the share price.",
    "increases the share price.",
    "A",
  ],
  [
    "An analyst gathers the following information about two companies' non-callable, non-convertible perpetual preference shares: Par value Required rate of return Annual dividend per share Q. The value of Preference Share 1 is:",
  ...
  [
    ...
    "use and pay for commercial transportation, if available.",
    "obtain written permission from his employer before he accepts this invitation.",
    "decline this invitation if he issues recommendations on the firm's securities.",
    "A",
  ],
  [
    ...
    "not in violation of any Standard or the Code of Ethics because she did not use the notes.",
    ...
    "in violation of both the Code of Ethics and the Standard governing conduct as participants in CFA Institute programs for taking the notes into the examination room.",
    "C",
  ],
  [
  ...
  [
    ...
    "Yes, because she didn't give complete details of the statistical model used.",
    "Yes, because she failed to indicate that 15% growth is an estimate.",
    "No, because her projections are within the generally accepted bounds of statistical accuracy.",
    "B",
  ],
  [
    "Dudley Thompson is a bond salesman for a small broker/dealer in London. His firm is the lead underwriter on a new junk bond issue for Ibex Corporation, and Thompson has sent details of the offering to clients. Thompson calls only his accounts over El for whom he thinks the issue is suitable. Thompson also posts his firm's optimistic projections for Ibex's performance in several Internet chat rooms. According to the Standards concerning market manipulation and fair dealing, Thompson is in violation of:",
    "both of these Standards.",
    "neither of these Standards.",
    "only one of these Standards.",
    "B",
  ...
  [
    ...
    "sell his shares of Tech before completing the report.",
    "disclose the ownership of the stock to his employer and in the report, if he writes it.",
    "C",
  ],
  [
    'Angie Franklin, CFA, who covers technology stocks, joins a conference call for analysts presented by Cynthia Lucas, chief technology officer for LevelTech. Lucas tells the analysts that overseas shipments of the company\'s important new product are going to be delayed due to manufacturing defects, which is new information to the analysts. After the meeting Franklin changes her rating on Level Tech from "buy" to "hold" and sends a note to accounts recommending the sale of LevelTech. Franklin:',
  ...
  [
    "According to the recommended procedures for complying with the Standard on suitability, which of the following statements regarding an investment policy statement (I PS) is least accurate? An IPS should describe the roles and responsibilities of both the adviser and the",
  ...
  [
    ...
    "Proxies have economic value to a client.",
    "An investment management firm should vote all proxies on client holdings unless the client reserves that right.",
    "Members and candidates should explicitly disclose the firm's proxy voting policies to clients.",
    "B",
  ],
  [
    ...
    "need not disclose the referral fee but cannot trade on the non-public information.",
    "must disclose the referral fee and cannot trade on the non-public information.",
    "must disclose the referral fee but may trade on the non-public information.",
    "B",
  ],
  [
  ...
  [
    "Hedge Funds Unlimited, a global hedge fund, has publicly acknowledged in writing that it has adopted the CFA Institute Code and Standards as its policies. Which of the following is least /ike/ya violation of the firm's policies? An analyst at the firm working overseas uses material nonpublic information as allowed by local law to make investment decisions for discretionary client accounts. A junior analyst at the firm uses a subscription to his local newspaper and the B) opinions of his friends and colleagues to make investment recommendations for discretionary client accounts. A CFA candidate at the firm, who is registered for the Level Ill exam, C) includes reference to participation in the CFA program and her status as a Level Ill candidate in her biographical background.",
    "An analyst at the firm working overseas uses material nonpublic information as allowed by local law to make investment decisions for discretionary client accounts.",
    "A junior analyst at the firm uses a subscription to his local newspaper and the opinions of his friends and colleagues to make investment recommendations for discretionary client accounts.",
    "A CFA candidate at the firm, who is registered for the Level III exam, includes reference to participation in the CFA program and her status as a Level III candidate in her biographical background.",
    "C",
  ],
  [
    "According to the Code and Standards, members and candidates who are involved in distributing an initial public offering (IPO) of equity shares and wish to participate in the I P O:",
  ...
  [
    ...
    "investment characteristics. report.",
    "send recommendations only to those clients for whom the investments are suitable.",
    "recommendations to clients must: not send recommendations without including the underlying analysis and basic keep records of all the data and analysis that went into creating the",
    "A",
  ],
  [
    "Amy Brooks, a Level III CFA candidate, has been given supervisory responsibilities. In carrying out her responsibilities, Brooks has discovered that the firm's compliance system is inadequate. She informed her supervisor, who is not supportive of Brooks's efforts to correct the situation. According to CFA Institute Standards of Professional Conduct, Brooks: has satisfied her obligation under the Code and Standards by informing her manager of the situation. must dissociate herself from the firm if the firm is not in compliance with the CFA B) Institute Standards. should decline in writing to accept supervisory responsibilities until an adequate compliance system is adopted.",
    "has satisfied her obligation under the Code and Standards by informing her manager of the situation.",
    "must dissociate herself from the firm if the firm is not in compliance with the CFA Institute Standards.",
    "should decline in writing to accept supervisory responsibilities until an adequate compliance system is adopted.",
    "C",
  ],
  [
  ...
  [
    ...
    "the plan trustees who hired him.",
    "the plan participants and beneficiaries.",
    "the managers, stockholders, and bondholders of Colors, Inc., equally.",
    "B",
  ],
  [
    'An analyst at Romer changes her rating on TelSky from "buy" to "hold" and sends an email explaining the change to all clients and firm brokers. Subsequently, Paul Stevens, CFA, a broker at Romer, receives a call from a client who wants to buy 1 5,000 shares of TelSky. Stevens must: advise his client of the change in recommendation before accepting the',
    "advise his client of the change in recommendation before accepting the order.",
    "not accept the order until the customer has had time to receive and read the new report.",
    "accept the order without mentioning the ratings change because the order is unsolicited.",
    "A",
  ],
  [
  ...
  [
    ...
    "must disclose the nature of the compensation from Hill in his research report.",
    "may not accept compensation from Hill to produce research on the company.",
    "may produce the research report but may not make a recommendation on Hill's securities.",
    "A",
  ],
  [
  ...
  [
    "Yvette Michaels, CFA, an analyst for Torborg Investments, inadvertently overhears a conversation between two executives of Collective Healthcare in which they mention an upcoming tender offer for Network, a stock she covers. Michaels has followed both companies extensively and feels their consolidation would be very beneficial for both",
    "in violation of the Standards.",
    "not in violation of the Standards because she told only her supervisor.",
    "companies. She tells her supervisor, a senior analyst, about the proposed tender not in violation of the Standards because she has not traded shares of Network or offer. Michaels' actions are: changed her report on the company.",
    "C",
  ],
  [
    "Kimberwick Technologies reported the following information for the year ending December 31. Data Net sales Cash expenses Cash inputs Cash taxes Increase in receivables Depreciation expense Cash flow from investing Cash flow from financing 50,000 3,250 17,000 7,000 500 1,ooo -5,000 -4,250 If the cash balance increased $13,000 over the year, cash flow from operations (CFO) is closest to:",
    "$21,250.",
    "$21,750.",
    "$22,250.",
    "C",
  ...
  [
    "A principal-agent conflict is most /ike/yto occur between:",
    "managers and employees.",
    "shareholders and senior managers.",
    "suppliers and the board of directors.",
    "B",
  ],
  [
    "A financial firm employs machine learning to model its risk exposures. The machine identifies a number of risk relationships in the input data, but the firm's management believes some of these relationships are spurious. If so, it is most /ike/ythat the model:",
  ...
  [
    ...
    "Interim SEC filings typically update the major financial statements and footnotes.",
    "Annual reports to shareholders are typically the most factual and objective source of information about a company.",
    "B",
  ],
  [
    "Which of the following is most /ike/ya motivation for a company's management to issue low-quality financial reports?",
  ...
  [
    "Consider the following foreign exchange and interest rate information: spot rate: 1.3382 USD/EUR. One year riskless USD rate = 2.5%. ' One year riskless EUR rate = 3.5%. The one-year arbitrage-free forward exchange rate is closest to:",
    "1.2391 USD/EUR.",
    "1.3253 USD/EUR.",
    "1.3513 USD/EUR.",
    "C",
  ...
  [
    ...
    "high debt-to-equity ratio. A company is most /ike/yto be viewed as having poor liquidity, compared to its industry, if it has a:",
    "A",
  ],
  [
  ...
  [
    "An analyst is forecasting market shares for the top three firms (which make up 90% of the market share) in a given market Scenario Firm Market Share Firm Jones Jones Jones Market Share 40% Firm Adams Adams Adams Market Share 2 3 Smith 40% Smith 35% Smith Which scenario produces the highest Herfindahl-Hirschman Index?",
    "Scenario 1.",
    "Scenario 2.",
    "Scenario 3.",
    "B",
  ...
  [
    "The five steps required for a company to record revenue are least /ike/yto include:",
  ...
  [
    "A simple linear regression model produces the following outputs: Total sum of squares 9,575.81 Mean regression sum of squares 7,115.74 Mean squared error 1,663.46 The F-statistic for this regression is closest to:",
    "1.3.",
    "4.3.",
    "5.8.",
    "B",
  ...
  [
    "In the context of the tools of geopolitics, voluntary export restraints are best categorized as:",
    "restrictive.",
    "cooperative.",
    "noncooperative.",
    "C",
  ...
  [
    "A central banles ability to achieve its policy goals is most /ike/yto be limited by available resources when which of the following actual rates is below its target rate?",
    "Interest rate.",
    "Inflation rate.",
    "Exchange rate.",
    "C",
  ...
  [
    "Other things equal, for a profitable company, issuing debt to repurchase outstanding stock will most /ike/y.",
  ...
  [
    "Conditions that most /ike/ysupport a high weight of debt in a company's capital structure include:",
    "operating in a cyclical industry.",
    "using a subscription-based revenue model.",
    "having a high degree of operating leverage.",
    "B",
  ],
  [
  ...
  [
    "57.5 — 7.58% -15% 57.5 Shortfall risk is best described as the probability:",
  ...
  [
    "Which of the following is least /ike/ya limitation of mechanisms used to discipline financial reporting quality?",
    "An unqualified audit opinion offers reasonable assurance rather than a guarantee. Securities regulators may require public disclosure of the results of",
    "disciplinary proceedings. Loan covenants may give the borrowing company an incentive to manipulate",
    "reported results.",
    "B",
  ],
  [
    "Given the following common-size cash flow statement: Cash Flow Statement Extract (Percentage of Revenues) Net income Accounts receivable Operating cash flow Cash from sale of fixed assets Purchase of plant and equipment Investing cash flow Cash dividends Total cash flow 13.4% 12.2% 0.7% 12.3% 11.6% -2.1% 1.1% 13.4% -0.5% 12.8% 0.75% -12.0% -11.3% -2.5% An analyst should most /ike/y conclude that:",
    "accounts receivable increased during the year.",
    "a smaller dividend was paid in 20X3 than 20X2.",
    "financing cash flow for 20X3 was -2.1% of revenue.",
    "A",
  ],
  [
    "If a company wishes to become public in a way that will generate new capital to fund several large projects, which of the following mechanisms will be most effective in providing the capital?",
    "Direct listing.",
  ...
  [
    ...
    "For a one-tailed test regarding the value of parameter X, the null hypothesis would be Ho: X = 0, and the alternative hypothesis would be HA: X 0.",
    "A",
  ],
  [
    "Agency costs of equity:",
    "are unaffected by capital structure.",
    "increase with greater debt in the capital structure.",
    "decrease with greater debt in the capital structure.",
    "C",
  ],
  [
  ...
  [
    "An analyst gathered the following data about a company: • Collections from customers are $5,000. Depreciation is $800. Cash expenses (including taxes) are $2,000. Tax rate 300/0. Net cash increased by $1,000. If inventory increases over the period by $800, cash flow from operations equals:",
    "$1,600.",
    "$2,400.",
    "$3,000.",
    "C",
  ...
  [
    "Greene Company discloses that its net income for the most recent period was reduced by a writedown of inventory to net realizable value. What effect is the inventory writedown most /ike/yto have on Greene's net income in future periods?",
    "Increase.",
    "Decrease.",
    "No effect.",
    "A",
  ...
  [
    ...
    "With positive skewness, the median is greater than the mean.",
    "If skewness is positive, the average magnitude of positive deviations from the mean is smaller than the average magnitude of negative deviations from the mean.",
    "If a return distribution has positive excess kurtosis and the analyst uses statistical models that do not account for the fatter tails, the analyst will underestimate the likelihood of extreme outcomes.",
    "C",
  ],
  [
  ...
  [
    "Which of the following is most /ike/y presented on a common-size balance sheet or common-size income statement?",
    "Total asset turnover.",
  ...
  [
    "A company has a two-tier structure for its board of directors. In this structure, independent directors serve on which group within the board?",
    "Staggered board.",
    "Supervisory board.",
    "Management board.",
    "B",
  ...
  [
    "Which of the following items is least /ike/yto contain details about various accruals, adjustments, balances, and management assumptions?",
    "Income statement.",
  ...
  [
    ...
    "financing from outside sources provides half of the $35 million cost.",
    "it does not proceed with the project until it has secured the $35 million in funding.",
    "A",
  ],
  [
  ...
  [
    "In the context of deciding on an appropriate forecast horizon, an inflection point is best described as a point at which:",
    "a full business cycle has been completed.",
    "future performance is likely to be different from the past.",
    "the analyst will decide whether to hold or remove the investment from the portfolio.",
    "B",
  ],
  [
    "Wreathfield, Inc., is choosing between two mutually exclusive projects. The cash flows for the two projects are below. The firm has a cost of capital of 1 2%, and the risk of the projects is equivalent to the average risk of the firm. Project J: Project K: o 1 2,000 -20,000 1 4,000 3,000 2 5,000 3,000 3 6,000 4 5 6 3,000 5,000 8,000 8,000 Wreathfield should accept:",
    "Project J.",
    "Project K.",
  ...
  [
    "$3,000 $5,000 $8,000 $8,000 4,000; CF2 = 5,000; CF3 = 6,000; CPT NPV = A country has implemented tariffs and import quotas. These policies are most /ike/yto result in:",
    "increased consumer surplus.",
    "higher prices for imported goods.",
    "decreased domestic quantity supplied.",
    "B",
  ],
  [
    "A permanent difference between pretax and taxable income is least /ike/yto arise when a firm:",
  ...
  [
    "In the most recent fiscal year, a company's cash conversion cycle was 45 days. If the company wishes to improve this measure by 5 days during the current year, they will most likely focus on increasing their:",
  ...
  [
    "Partial table of Student's t-distribution: Level of Significance for a Two-Tailed Test df 0.20 0.10 0.05 0.02 0.01 0.001",
    "is closest to: 16 to 82.",
    "From a sample of 25 paired observations, an analyst generates the simple linear 187 to 253.",
    "regression line Yi = —25 + 49Xi. The standard error of the forecast is 16. For an 218 to 272. observed value of X equal to 5, a 95% confidence interval for the predicted value of Y",
    "B",
  ],
  [
  ...
  [
    "In a period of rising prices, management of a company that reports under IFRS is least /ike/yto attempt to influence analysts' opinions of its financial results by:",
  ...
  [
    "An unexpected increase in businesses' inventory-to-sales ratios is most /ike/yto occur as an economy:",
    "reaches a trough.",
    "enters a contraction phase.",
    "approaches the peak of an expansion.",
    "C",
  ],
  [
    "Relative to economic cycles, credit cycles:",
    "coincide with economic cycles.",
    "tend to dampen economic cycles.",
    "have historically been longer than economic cycles.",
    "C",
  ],
  [
    "A change from a neutral monetary policy to a contractionary monetary policy is most /ike/yto be reflected in the economy by:",
    "decreases in price for financial assets.",
    "decreased lending rates in the banking system.",
    "depreciation of the domestic currency in the foreign exchange market.",
    "A",
  ],
  [
  ...
  [
    ...
    "a sunk cost.",
    "an opportunity cost.",
    "$1 50 each per month for its fleet of taxis. The firm currently has 18 taxis in operation an incremental cost. and is performing an NPV analysis on the purchase of a 1 9th taxi. The cost of parking for the 19th taxi is best described as:",
    "C",
  ],
  [
  ...
  [
    ...
    "0.6% if the hurdle rate is hard.",
    "0.9% if the hurdle rate is soft.",
    "1.2% whether the hurdle rate is hard or soft.",
    "A",
  ],
  [
    "FQ Corporation currently has EUR 40 million par value second lien bonds outstanding. Investors in FQs new EUR 10 million senior unsecured bonds would:",
    "be senior in priority to the second lien bonds.",
    "rank pari passu in priority to the second lien bonds.",
    "be subordinated in priority to the second lien bonds.",
    "C",
  ],
  [
    "Mark Stewart is an executive of a publicly traded company in a country that has weak insider trading regulations. If Stewart can trade on insider information about his company and earn abnormal returns over time, the country's market may be most accurately characterized as:",
  ...
  [
    "If a companys forecast current liability balances reflect an undesirable net working capital position, the company is most likely faced with:",
    "solvency risk.",
    "accounting risk.",
    "operational risk.",
    "A",
  ...
  [
    "Annual spot interest rates are as follows:, I-year: 3.5% 2-year: 3.7% 3-year: 4.0% 4-year: 4.2% Based on these spot rates, the 4-year par rate is closest to:",
    "3.92%.",
    "4.05%.",
    "4.18%.",
    "C",
  ...
  [
    ...
    "stability from fixed coupon rates.",
    "low correlations of returns with other investments.",
    "C",
  ],
  [
    "In a derivatives contract that is subject to novation:",
    "the seller is required to own and hold the underlying.",
    "either counterparty may exit the contract by paying a stated fee.",
    "a central clearinghouse takes the opposite positions to both the buyer and the seller.",
    "C",
  ],
  [
    "A borrower under a repurchase (repo) transaction would like to borrow exactly $100,000. If the repo haircut is 3%, the borrower must provide as collateral bonds worth:",
    "less than $103,OOO.",
    "exactly $103,OOO.",
    "more than $103,000.",
    "C",
  ...
  [
    "Which of the following real estate investment vehicles or strategies is most /ike/yto provide a risk-return profile similar to that of equity investments?",
    "Core strategies.",
    "Value-add strategies.",
    "Investment grade commercial MBS.",
    "B",
  ],
  [
    "Assuming a forecast object will converge to a historical base rate is most appropriate for:",
    "mature industries.",
    "cyclical industries.",
    "growth industries.",
    "A",
  ...
  [
    "A manager states that the objectives of a firm's risk management process should be to: Identify the firm's risk tolerance. ' Identify and measure risks faced by the organization. ' Minimize or eliminate these risks. Which of these objectives is least appropriate in a risk management process?",
  ...
  [
    ...
    "time to maturity is shorter.",
    "C",
  ],
  [
    "An industry is experiencing a significant increase of unionized labor. In the context of Porter's Five Forces, this change most likely implies:",
    "decreasing threat of new entrants.",
    "increasing bargaining power of suppliers.",
    "decreasing bargaining power of customers.",
    "B",
  ],
  [
    "Which of the following statements is most accurate regarding a core-satellite approach to asset allocation? Both the core and satellite portfolios utilize active strategies designed to reduce excessive trading. Passively managed indexes are used for the core portfolio and active B) strategies are used for the satellite portfolio. Active strategies are used for the core portfolio and passively managed strategies C) are used for the satellite portfolio.",
    "Both the core and satellite portfolios utilize active strategies designed to reduce excessive trading.",
    "Passively managed indexes are used for the core portfolio and active strategies are used for the satellite portfolio.",
    "Active strategies are used for the core portfolio and passively managed strategies are used for the satellite portfolio.",
    "B",
  ],
  [
    "Bond 1 is an option-free, 3% semiannual coupon, 5-year bond. Bond 2 is a callable bond that is otherwise identical to Bond 1. Compared to Bond 1, Bond 2 has a(n):",
    "lower option-adjusted price.",
    "equal option-adjusted price.",
    "higher option-adjusted price.",
    "B",
  ],
  [
    "Among real estate investment forms, a mortgage REIT is most accurately described as a(n):",
    "equity investment.",
  ...
  [
    "The source of a hedge fund's return that is attributable to security selection is best described as:",
    "alpha.",
    "market beta.",
    "strategy beta.",
    "A",
  ...
  [
    "An increase in which of the following will decrease the net cost of carry for a commodity?",
    "Storage cost.",
    "Convenience yield.",
  ...
  [
    "A portfolio manager is most /ike/yto complete a top-down analysis of the investment environment in which step of the portfolio management process?",
    "Planning.",
    "Execution.",
    "Feedback.",
    "B",
  ...
  [
    "Changes in a fixed-coupon bondls cash flows that result from changes in yield would be reflected in the bond's:",
    "effective duration.",
    "modified duration.",
    "Macaulay duration.",
    "A",
  ...
  [
    "An analyst gathered the following data about three stocks: Stock Beta Estimated Return A B c 1.5 1.1 0.6 18.1% 15.7% 12.5% If the risk-free rate is 8%, and the market risk premium is 7%, the analyst is least /ike/y to recommend buying:",
    "Stock A.",
    "Stock B.",
    "Stock C.",
    "A",
  ...
  [
    "A Canadian city issues a CAD 100 million general obligation bond. Which of the following credit measures is most relevant in analyzing the risk of this bond?",
    "Minimum coverage ratio covenants.",
    "Attractiveness of the local business climate.",
    "Riskiness of cash flows from infrastructure funded by the bonds.",
    "B",
  ],
  [
    "In explaining the merits of natural resource investments such as raw land, timberland, and farmland to her clients, a financial advisor can most accurately state that:",
    "farmland is typically held by institutions.",
    "liquidity is a primary concern for all three investments.",
    "farmland lot sizes are usually bigger than timberland lot sizes.",
    "B",
  ],
  [
    "What is the main benefit of a permissionless network, in contrast with a permissioned network? A permissionless network:",
    "is more cost efficient.",
    "has no single point of failure.",
    "enables faster transfer of ownership.",
    "B",
  ],
  [
    "For a stock that has a beta of 0.95, it is most /ike/ythat:",
    "the slope of its characteristic line is 0.95.",
    "the market is 95% as volatile as this individual stock.",
    "the variance of the market return is 95% of the covariance of the stock's return with the market return.",
    "A",
  ],
  [
    "A hedge fund manager is estimating a value for a non-traded bond of Yoder Company. The bond has an annual-pay 6% coupon, matures in six years, and has a CCC credit rating. Actively traded annual-pay bonds with similar credit ratings include the following: Coupon Maturity Yield to maturity 8% 5% 7% 5 years 5 years 10 years 9.45% 9.55% 10.00% Based on matrix pricing, the value of the Yoder bond as a percentage of par is closest to:",
    "83.9.",
    "84.1.",
    "84.5.",
    "B",
  ...
  [
    "An analyst is most /ike/yto examine a companys channel strategy when evaluating the company's:",
    "pricing power.",
    "business model.",
    "revenue drivers.",
    "B",
  ...
  [
    "Co-investing is most accurately described as investing: as a limited partner in an investment fund, but only committing capital to one or",
  ...
  [
    "Other things equal, the value of a long position in a forward contract priced at will most /ike/ybe higher during its life at time tif the:",
  ...
  [
    "A university endowment commits $80 million to Lawson Private Capital Fund. Lawson charges a 1% management fee per year and incentive fees of 20% on all gains, and has an American-style waterfall structure with no clawback. Lawson draws down the endowment's capital to invest in the following portfolio companies: Portfolio company Investment Adams Borland Chambers $20 million in Year 1 $25 million in Year 2 $30 million in Year 3 Cash received on exit $30 million in Year 3 $45 million in Year 4 $20 million in Year 5 At the end of Year 5, the investor's total gain after fees is closest to:",
    "$10 million.",
    "$12 million.",
    "$14 million.",
    "A",
  ...
  [
    "— 150 The assertion that investors, analysts, and portfolio managers exhibit psychological tendencies that cause them to make systematic errors is most consistent with:",
    "behavioral finance.",
  ...
  [
    "Reasons why no-arbitrage pricing models for forward commitments differ from no- arbitrage pricing models for contingent claims least /ike/y include the fact that contingent claims:",
    "are leveraged.",
    "have one-sided payoffs.",
    "have nonzero values at initiation.",
    "A",
  ],
  [
  ...
  [
    "A bond with nine years to maturity is quoted at an interpolated spread of +1 50 basis points. The benchmark yield for this bond is:",
    "a swap rate.",
    "a matrix rate.",
  ...
  [
    "Among valuation models, the difficulty of estimating a required rate of return is most /ike/yto be a disadvantage of using:",
    "a Gordon growth model.",
  ...
  [
    "When the management team of a public company is replaced by the private equity manager in a leveraged buyout (LBO) fund, the type of LBO is best described as a(n):",
  ...
  [
    ...
    "Net worth is unrelated to an investor's risk tolerance.",
    "This approach does not consider the investor's attitude toward risk.",
    "Treating clients differently based on their ages violates the Code and Standards.",
    "B",
  ],
  [
  ...
  [
    "With expected return on the Y-axis (vertical) and portfolio risk as measured by standard deviation on the X-axis (horizontal), a risk-averse investor's indifference curves will:",
    "be flat.",
    "curve upward.",
    "curve downward.",
    "B",
  ...
  [
    "An analyst gathered the following data about a company: ' The historical earnings retention rate of 40% is projected to continue into the future. The sustainable ROE is 12%. ' The stock's beta is 1.2. The nominal risk-free rate is 6%. The expected market return is 11%. If the analyst believes next year's earnings will be $4 per share, what value should be placed on this stock?",
    "$22.24.",
    "$33.32.",
    "$45.45.",
    "B",
  ...
  [
    "0.6 — 8.33 The type of equity depository receipt that gives its owners the right to vote and receive dividends from a companys shares is best described as:",
  ...
  [
    "Consider the following Treasury spot rates expressed as bond equivalent yields: Maturity Spot Rate 6 months I year 1.5 years 2 years 3.0% 3.5% 4.0% 4.5% If a Treasury note with two years remaining to maturity has a 5% semiannual coupon and is priced at $1,008, the note is:",
    "overpriced.",
    "underpriced.",
    "correctly priced.",
    "B",
  ...
  [
    "An increase in the risk-free rate, together with an increase in the expected volatility of the price of the underlying asset, will most /ike/y lead to a gain for a:",
    "long call option.",
    "long put option.",
    "short put option.",
    "C",
  ...
  [
    ...
    "Internal rate of return over the investment's life.",
    "C",
  ],
  [
    "The full price of a bond:",
    "includes accrued interest.",
    "includes commissions and taxes.",
  ...
  [
    "The type of equity index most /ike/yto require rebalancing is:",
  ...
  [
    "The derivative that is least /ike/yto have a value of zero at initiation is:",
  ...
  [
    ...
    "are more likely to be mitigated through education than emotional biases.",
    "are essentially processing errors, while emotional biases tend to involve belief perseverance.",
    "typically lead to errors of commission, while emotional biases typically lead to errors of omission.",
    "A",
  ],
  [
  ...
  [
    ...
    "A short seller is required to set up a margin account.",
    "A short sale involves securities the investor does not own.",
    "A short seller loses if the price of the stock sold short decreases.",
    "C",
  ],
  [
  ...
  [
    "0.0561 A public offering of bonds issued over a period of time is most accurately described as:",
    "a serial structure.",
  ...
  [
    "Compared to an index of 100 U.S. exchange-traded stocks, an index of 100 U.S. government and corporate bonds will most /ike/y.",
  ...
  [
    ...
    "spot rates at I-year intervals for the 6-year period.",
    "C",
  ],
  [
    "In a two-asset portfolio where 20% is invested in the risk-free asset, the standard deviation of the portfolio will be:",
    "80% of the standard deviation of the risky asset.",
    "less than 80% of the standard deviation of the risky asset.",
    "more than 80% of the standard deviations of the risky asset.",
    "A",
  ],
  [
    "Which of the following types of institutions is most /ike/yto have the lowest risk tolerance?",
    "Commercial bank.",
    "College endowment.",
    "Mutual fund company.",
    "A",
  ...
  [
    "Public-private partnerships are most /ike/yto be a vehicle for investing in:",
...
const RAW_EXAMS = [
  [
    "mock-1-s1",
    "Mock Exam 1 - Session 1",
    "90 Qs - Source session 1",
    "q1",
    "q90",
  ],
  [
    "mock-1-s2",
    "Mock Exam 1 - Session 2",
    "90 Qs - Source session 2",
    "q91",
    "q180",
  ],
  [
    "mock-2-s1",
    "Mock Exam 2 - Session 1",
    "90 Qs - Source session 1",
    "q181",
    "q270",
  ],
  ...
  [
    "kaplan-mock-1-s2",
    "Kaplan Mock 1 - Session 2",
    "90 Qs - Kaplan Q91-180",
    "q991",
    "q1080",
  ],
] as const;
const MOCK_EXAM_QUESTIONS: Question[] = RAW_QUESTIONS.map((row, index) => {
  ...
  return {
    ...
    explanation:
      MOCK_1_SESSION_1_EXPLANATIONS[`q${index + 1}`] ??
      `Correct answer: ${row[offset + 4]}`,
    difficulty: "medium",
    ...MOCK_1_SESSION_1_QUESTION_OVERRIDES[id],
  } as Question;
});
...
export const MOCK_EXAMS: MockExam[] = RAW_EXAMS.map(
  ([id, title, description, firstId, lastId]) => {
    const first = Number(firstId.slice(1));
    const last = Number(lastId.slice(1));
    return {
      id,
      title,
      description,
      questionCount: last - first + 1,
      durationMinutes: 135,
      level: "I",
      createdAt: "2026-05-19T00:00:00Z",
      questionIds: Array.from(
        { length: last - first + 1 },
        (_, index) => `q${first + index}`,
      ),
    };
  },
);
